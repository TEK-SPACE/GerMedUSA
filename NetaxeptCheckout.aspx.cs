...
namespace AspDotNetStorefront
{
    ...
    public partial class NetaxeptCheckout : System.Web.UI.Page
    {
        ...
        protected void Page_Load(object sender, EventArgs e)
        {
            ...
            bool UseOnePageCheckout = AppLogic.AppConfigBool("Checkout.UseOnePageCheckout");
            bool UseFinalReviewOrderPage = AppLogic.AppConfigBool("Checkout.UseOnePageCheckout.UseFinalReviewOrderPage");
            
            string SkinImagePath = "skins/skin_" + Customer.Current.SkinID.ToString() + "/images/";
            loadingshipping.ImageUrl = AppLogic.LocateImageURL(SkinImagePath + "loadingshipping.gif");
            ...
            AspDotNetStorefrontGateways.Netaxept netaxeptBBS = new AspDotNetStorefrontGateways.Netaxept();
            ...
            Decimal OrderTotal = CartTotal - CommonLogic.IIF(cart.Coupon.m_CouponType == CouponTypeEnum.GiftCard, CommonLogic.IIF(CartTotal < cart.Coupon.m_DiscountAmount, CartTotal, cart.Coupon.m_DiscountAmount), 0);
            ...
            if (setUp.IndexOf(AppLogic.GetString("toc.aspx.6", Customer.Current.SkinID, Customer.Current.LocaleSetting)) != -1)
            {
                ...
                if (AppLogic.AppConfigBool("NETAXEPT.Error.Setup"))
                {
                    ...
                    {
                          Response.Redirect("checkout1.aspx?errormsg=" + Server.UrlEncode(setUp));
                    }

                    Response.Redirect("CheckoutPayment.aspx?nexaxepterror=" + Server.UrlEncode(setUp));
                }
            }
            else
            {
