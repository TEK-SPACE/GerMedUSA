            ...
            <td valign="top" align="left">
                <asp:Panel ID="pnlBeforeSignup" runat="server" Visible="true">
                    <table cellspacing="0" cellpadding="0" width="171" border="0">
                        <tr>
                            <td class="AffiliateHeaderTd">
                                &nbsp;<asp:Label ID="AppConfigAffiliateProgramName" runat="server"></asp:Label></td>
                        </tr>
                    ...
                    <table cellspacing="0" cellpadding="0" width="171" border="0">
                        <tr>
                            <td class="AffiliateHeaderTd" height="18">
                                &nbsp;Learn More</td>
                        </tr>
                        <tr valign="middle" align="center">
                            <td class="AffiliateTextCell">
                ...
                <asp:Panel ID="pnlAfterSignup" runat="server" Visible="false">
                    <table cellspacing="0" cellpadding="0" width="171" border="0">
                        <tr>
                            <td class="AffiliateHeaderTd">
                                &nbsp;<asp:Label ID="AppConfigAffiliateProgramName4" runat="server"></asp:Label></td>
                        </tr>
                        <tr valign="middle" align="center">
                            <td class="AffiliateTextCell">
                                <table cellspacing="0" cellpadding="4" width="100%" border="0">
