<%@ Page language="c#" Inherits="AspDotNetStorefront.requestcatalog" CodeFile="requestcatalog.aspx.cs" %>
...
<body>
    <form runat="server">
        ...
        <asp:Panel ID="pnlSuccess" runat="server" Visible="false">
            <br /><asp:Label ID="lblSuccess" runat="server" Font-Bold="true"></asp:Label><br />
        </asp:Panel>
    </form>
</body>
</html>