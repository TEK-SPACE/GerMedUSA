...
namespace AspDotNetStorefront
{
    ...
    public partial class rateit : System.Web.UI.Page
    {
        ...
        protected void Page_Load(object sender, System.EventArgs e)
        {
            ...
            cssref.Attributes.Add("href", "skins/Skin_" + SkinID.ToString() + "/style.css");
            ...
            {
                conn.Open();
                using (IDataReader rs = DB.GetRS("select * from Rating   with (NOLOCK)  where CustomerID=" + ThisCustomer.CustomerID.ToString() + " and ProductID=" + ProductID.ToString(), conn))
                {
                    if (rs.Read())
                    {
