...
<body>
    ...
    <form runat="server">
                        ...
                        <asp:Table ID="tblShippingInfoBox" CellSpacing="0" CellPadding="2" Width="100%" runat="server">
                            <asp:TableRow>
                                <asp:TableCell HorizontalAlign="left" VerticalAlign="top">
                                    ...
                                    <br />
                                    <center><asp:Button ID="btnNewShipAddr" runat="server" Text="(!checkoutshipping.aspx.21!)" CssClass="ShippingPageContinueCheckoutButton" Visible="true" ValidationGroup="shipping1" OnClick="btnNewShipAddr_OnClick" /></center>
                                </asp:TableCell>
                            </asp:TableRow>
                        </asp:Table>
                    </asp:TableCell>
        ...
        <center><asp:Button ID="btnContinueCheckout" runat="server" Text="(!checkoutshipping.aspx.13!)" CssClass="ShippingPageContinueCheckoutButton" Visible="false" /></center>
