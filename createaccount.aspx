<%@ Page ClientTarget="UpLevel" language="c#" Inherits="AspDotNetStorefront.createaccount" CodeFile="createaccount.aspx.cs" MaintainScrollPositionOnPostback="true"%>
    ...
    <asp:Panel ID="pnlMain" runat="server" HorizontalAlign="Center" Visible="true">
        ...
        <form id="frmCreateAccount" runat="server">        
                                    ...
                                    <asp:TableCell HorizontalAlign="left" VerticalAlign="top">
                                        <table border="0" cellpadding="2" cellspacing="2" width="100%">
                                            ...
                                            <tr>
                                                ...
                                                <td width="65%">
                                                    <asp:TextBox ID="Phone" runat="server" CausesValidation="true" Columns="14" MaxLength="25" ValidationGroup="registration"></asp:TextBox>
                                            ...
                                            <tr>
                                                ...
                                                <td width="65%"><asp:CheckBox ID="Over13" Visible="true"  runat="server" />
                                                <asp:CustomValidator ID="valRequireOver13"  EnableClientScript="false" runat="server" ValidationGroup="registration" Display="None" OnServerValidate="valRequireOver13_ServerValidate" ></asp:CustomValidator>
                                                </td>             
                                            </tr>
											</asp:panel>
                                            <tr>
            ...
            <asp:Panel ID="pnlSkipReg" runat="server" Visible="false" HorizontalAlign="Left">
                ...
                <asp:TextBox ID="txtSkipRegEmail" runat="server" Columns="30" MaxLength="100" ValidationGroup="skipreg" ></asp:TextBox> <small><asp:Literal ID="Literal4" runat="server" Text="(!createaccount.aspx.81!)"></asp:Literal></small>
                ...
                <br /><asp:Literal ID="Literal2" runat="server" Text="(!createaccount.aspx.78!)"></asp:Literal> <asp:CheckBox ID="SkipRegOver13" Visible="true"  runat="server" CausesValidation="True" ValidationGroup="registration" />                
            </asp:Panel>
                                    ...
                                    <asp:TableCell HorizontalAlign="left" VerticalAlign="top">
                                        ...
                                        <table border="0" cellpadding="2" cellspacing="0" width="100%">
                                            ...
                                            <tr>
                                                ...
                                                <asp:CustomValidator ID="valAddressIsPOBox" EnableClientScript="false" runat="server" ValidationGroup="createaccount" Display="None" OnServerValidate="ValidateAddress" ></asp:CustomValidator>
                                                </td>
                                            </tr>
                                            <tr>
