    ...
    public partial class popup : System.Web.UI.Page
    {
        protected void Page_Load(object sender, System.EventArgs e)
        {
            ...
            if (CommonLogic.QueryStringCanBeDangerousContent("src").Length != 0)
            {
                ...
                string sSrc2 = CommonLogic.QueryStringCanBeDangerousContent("src2");               

                if (sSrc.ToLowerInvariant().Contains("wolthuis"))
                {
                    sSrc += CommonLogic.IsStringNullOrEmpty(sSrc2) ? string.Empty : string.Format("&src2={0}", sSrc2);
                ...
                Response.Write("<img name=\"Image1\" onClick=\"javascript:self.close();\" style=\"cursor:hand;cursor:pointer;\" alt=\"" + AppLogic.GetString("popup.aspx.1", 1, Localization.GetWebConfigLocale()) + "\" border=\"0\" src=\"" + Server.HtmlEncode(sSrc) + "\">\n");
                Response.Write("<br/>");
            }
