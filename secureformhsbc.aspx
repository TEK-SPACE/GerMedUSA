<%@ Page Language="c#" Inherits="AspDotNetStorefront.secureformHSBC" CodeFile="secureformhsbc.aspx.cs" %>
...
<body>
    ...
    <asp:Panel ID="Panel2" runat="server" Width="100%" Visible="true">
        ...
        <br />
        <div>
            <iframe src="secureauthHSBC.aspx" width="100%" height="500" scrolling="auto" frameborder="0" style="margin: 0px; padding: 8px; border-width: 1px; border-style: solid; border-color: #888888;">
            </iframe>
        </div>
    </asp:Panel>
</body>
