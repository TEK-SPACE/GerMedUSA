    ...
    <form runat="Server">
        ...
        <div align="left" width="100%">
            ...
            <asp:Panel ID="FormPanel" runat="server" Width="90%">
                    <table cellspacing="0" cellpadding="1" width="90%" border="0" id="table1">
                        <tr>
                            <td valign="top" width="45%">
                                ...
                                <table cellspacing="0" cellpadding="0" width="100%" border="0" id="table2">
                                    <tr>
                                        <td><asp:Label ID="Label2" runat="server" Text="(!checkoutanon.aspx.4!)" Font-Bold="true" /></td>
                                    </tr>
                                    <tr>
                                        <td>
                                    ...
                                    <tr>
                                        <td><asp:Label ID="Label3" runat="server" Text="(!checkoutanon.aspx.5!)" Font-Bold="true" /></td>
                                    </tr>
                                    <tr>
                                        <td>
                                    ...
                                    <tr>
                                        <td>                
                                            <asp:Label ID="Label18" runat="server" Text="(!signin.aspx.21!)" Visible="False"></asp:Label>
                                            <br />
                                        </td>
                                    </tr>
                                    <tr>
                                        <td>
                                            <asp:TextBox ID="SecurityCode2" runat="server" Visible="False" ValidationGroup="Group3" CausesValidation="True" Width="157px" EnableViewState="False"></asp:TextBox>
                                            <asp:RequiredFieldValidator ID="RequiredFieldValidator9" runat="server" ControlToValidate="SecurityCode2" ErrorMessage="(!signin.aspx.20!)" ValidationGroup="Group3" Enabled="False"></asp:RequiredFieldValidator>
                                        <br />
                                        </td>
                                    </tr>
                                    <tr>
                                    ...
                                    <tr>
                                        <td valign="top">
                                            <asp:Button ID="btnSignInAndCheckout" CssClass="UpdateCartButton" Text="(!checkoutanon.aspx.13!)" runat="server" ValidationGroup="Group1" CausesValidation="true" OnClick="btnSignInAndCheckout_Click" />
                                            <br /><br />
                            ...
                            <td valign="top" width="45%">
                                ...
                                <asp:Button ID="RegisterAndCheckoutButton" CssClass="UpdateCartButton" Text="(!checkoutanon.aspx.14!)" runat="server" CausesValidation="false" OnClick="RegisterAndCheckoutButton_Click"  />
                                <br /><br />
                                ...
                                <asp:Panel runat="Server" ID="PasswordOptionalPanel" Visible="false">
                                    ...
                                    <asp:Button ID="Skipregistration" CssClass="UpdateCartButton" Text="(!checkoutanon.aspx.15!)" runat="server" CausesValidation="false" OnClick="Skipregistration_Click" />
                                </asp:Panel>
                            </td>
                        </tr>
                    </table>
