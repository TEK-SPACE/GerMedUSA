...
<body>
    ...
    <form runat="server">
        <asp:Panel ID="pnlNoPaymentRequired" runat="server" HorizontalAlign="Center" Visible="false">
            ...
            <asp:Button ID="btnContinueCheckOut1" runat="server" Text="(!checkoutpayment.aspx.18!)" CssClass="PaymentPageContinueCheckoutButton" />
        </asp:Panel>
        <asp:Panel ID="pnlPaymentOptions" runat="server" HorizontalAlign="left" Visible="true">
            <table cellpadding="0" cellspacing="0" border="0">
                ...
                <tr>
                    <td><asp:RadioButton GroupName="PaymentSelection" ID="pmtCardinalMyECheck" Text="(!checkoutpayment.aspx.13!)" runat="server" Visible="false" AutoPostBack="true" /></td>
                    <td></td>
                </tr>
                <tr>
        ...
        <asp:Panel runat="server" ID="pnlNetaxept" Visible="true" EnableViewState = "false" HorizontalAlign="center" style="width: 90%; border: 1px; border-style: solid; padding-left: 10px; padding-top: 10px; padding-right: 10px; padding-bottom: 20px;">         
           <asp:Button ID="btnNetaxept" runat="server" onclick="btnNetaxept_Click" />
            <br />
             <asp:Literal ID="ltlReq" runat="server"></asp:Literal>
            <asp:Label ID="lblNetaxepterror" runat="server" EnableViewState="false" style="color:Red" Text="Label" Visible="false"></asp:Label>
        </asp:Panel>
    </form>
