...
<body>
    ...
    <aspdnsf:Topic runat="server" ID="HeaderMsg" TopicName="AccountPageHeader" />
                      ...
                      <table border="0" cellpadding="4" cellspacing="0" width="100%">
                        ...
                        <tr>
                          ...
                          <td width="65%" align="left" valign="middle"><asp:TextBox ID="EMail" Columns="37" MaxLength="100" runat="server" ValidationGroup="account" CausesValidation="true"></asp:TextBox>
                            ...
                            <asp:RegularExpressionValidator id="RegExValEmail" runat="SERVER" Display="None" ControlToValidate="EMail" ValidationGroup="account" EnableClientScript="false" ErrorMessage="E-Mail address is invalid" ValidationExpression="^[a-zA-Z0-9][-\w\.\+]*@([a-zA-Z0-9][\w\-]*\.)+[a-zA-Z]{2,4}$"></asp:RegularExpressionValidator></td>
                        </tr>
                        ...
                        <tr>
                          ...
                          <td width="65%" align="left" valign="top">
                            <asp:TextBox ID="CustPassword" TextMode="Password" Value="[Click Here]" onfocus="if(this.value=='[Click Here]')this.value=''" Columns="20" maxlength="50" runat="server" ValidationGroup="account" CausesValidation="true"></asp:TextBox> <asp:Label ID="accountaspx19" runat="server" Text="(!account.aspx.19!)"></asp:Label>
                        ...
                        <tr>
                          ...
                          <td width="65%" align="left" valign="middle"><asp:TextBox id="Phone" Columns="14" MaxLength="25" runat="server" /></td>
                        ...
                        <tr>
                            ...
                            <asp:CustomValidator ID="valRequireOver13"  EnableClientScript="false" runat="server" ValidationGroup="account" Display="None" OnServerValidate="valRequireOver13_ServerValidate"></asp:CustomValidator>
                        </tr>
						</asp:panel>
        ...
        <center>
            <p>
                <asp:Button ID="btnUpdateAccount" CssClass="UpdateAccountButton" Text="(!account.aspx.28!)" runat="server" CausesValidation="true" ValidationGroup="account" OnClick="btnUpdateAccount_Click"  />
                        ...
                        <asp:Repeater ID="orderhistorylist" runat="server">
                            ...
                            <ItemTemplate>
                                <tr>
                                    ...
                                    <td align="center" valign="top" width="150px"><%#AspDotNetStorefrontCore.Localization.ConvertLocaleDateTime(DataBinder.Eval(Container.DataItem, "OrderDate").ToString(), Localization.GetWebConfigLocale(), ThisCustomer.LocaleSetting)%></td>
