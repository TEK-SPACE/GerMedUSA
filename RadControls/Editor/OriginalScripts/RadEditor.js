...
var _5e=_5d.cloneNode(true);
var _5f=_5d.ownerDocument.createElement("DIV");
_5f.appendChild(_5e);
return _5f.innerHTML;
}
},GetIntValue:function(_60,_61){
if(!_61){
_61=0;
}
var _62=parseInt(_60);
return (isNaN(_62)?_61:_62);
},HasHtmlContent:function(_63){
if(!_63||!_63.match){
return _63;
}
return _63.match(/</);
...
var _65=url.indexOf("//");
if(_65>=0){
_65=url.indexOf("/",_65+2);
if(_65>=0){
return url.substring(_65);
}
}
return url;
},RemoveElementStyleAttribute:function(_66,_67){
if(_66.style&&_66.style[_67]){
_66.style[_67]=null;
if(_66.style.removeAttribute){
_66.style.removeAttribute(_67);
}
if(_66.style.cssText){
}else{
_66.removeAttribute("style");
}
}
},EscapeRegexSpecialChars:function(_68){
_68=_68.replace(/\\/ig,"\\\\");
_68=_68.replace(/&/ig,"&amp;");
_68=_68.replace(/\?/ig,"\\?");
_68=_68.replace(/\+/ig,"\\+");
...
_68=_68.replace(/\|/ig,"\\|");
return _68;
},_copyElementsBetweenNodes:function(_69,_6a,_6b){
var _6c=_69.getElementsByTagName(_6b);
var _6d=_6a.getElementsByTagName(_6b);
for(var i=0;i<_6c.length;i++){
switch(_6b){
case "SCRIPT":
_6d[i].text=_6c[i].text;
break;
default:
this.setElementInnerHtml(_6d[i],_6c[i].innerHTML);
break;
}
}
},cloneNodeWithChildren:function(_6f){
if(!_6f){
return null;
}
if(window.RadControlsNamespace.Browser.IsIE&&_6f.getElementsByTagName){
var _70=_6f.cloneNode(true);
if(typeof (_70.innerHTML)!="string"){
this.setElementInnerHtml(_70,_6f.innerHTML);
}
this._copyElementsBetweenNodes(_6f,_70,"SCRIPT");
this._copyElementsBetweenNodes(_6f,_70,"MAP");
return _70;
}else{
return _6f.cloneNode(true);
}
},setElementInnerHtml:function(_71,_72){
var _73=window.RadControlsNamespace.Browser.IsIE?this.getStoredOriginalPathsAndAttributes(_72):_72;
_71.innerHTML="<span>&nbsp;</span>"+_73;
_71.removeChild(_71.firstChild);
if(window.RadControlsNamespace.Browser.IsIE){
this.restoreOriginalPathsAndAttributes(_71);
}
},getStoredOriginalPathsAndAttributes:function(_74){
var _75=function(_76,g1,g2,g3,g4,g5,_7c,_7d){
if(!g2){
g2="";
g3=g3+g5;
var _7e=g3.search(/(\s|>)/gi);
if(_7e>0){
g5=g3.substring(_7e,g3.length);
g3=g3.substring(0,_7e);
}else{
return _76;
}
}
...
var _7f=new RegExp("\\s(href|src)\\s*=\\s*('|\")?(.+?)(\\2)([^<]*?>)","ig");
_74=_74.replace(_7f,_75);
var _80=new RegExp("(<!--[\\s\\S]*?) originalAttribute=\"(href|src)\" originalPath=\"[^\"]+\"([\\s\\S]*?-->)","ig");
var _81=_74.length+1;
while(_74.length<_81){
_81=_74.length;
_74=_74.replace(_80,"$1$3");
}
return _74;
},restoreOriginalPathsAndAttributes:function(_82){
var _83=_82.getElementsByTagName("*");
for(var i=0;i<_83.length;i++){
var _85=_83[i];
var _86=_85.getAttribute("originalPath");
var _87=_85.getAttribute("originalAttribute");
if(_86!=null&&_87!=null){
_85.removeAttribute("originalPath");
_85.removeAttribute("originalAttribute");
if(_86.toLowerCase().indexOf("mailto:")==0){
continue;
}
_86=_86.replace(window.location.href+"#","#");
_85.removeAttribute(_87);
var _88=_85.innerHTML;
_85.setAttribute(_87,_86);
if(_88!=_85.innerHTML){
_85.innerHTML=_88;
}
}
}
...
var _168=_163.match(/<body/gi);
if(_168&&_168.index==0){
...
var _16b=oDoc.getElementsByTagName("link");
var _16c=oDoc.getElementsByTagName("style");
var _16d=[];
for(var x=0;_16b[x];x++){
var rel=_16b[x].rel?_16b[x].rel:_16b[x].getAttribute("rel");
if(typeof (rel)=="string"&&rel.toLowerCase().indexOf("style")+1){
_16d[_16d.length]=_16b[x];
}
}
for(var x=0;_16c[x];x++){
_16d[_16d.length]=_16c[x];
}
return _16d;
},copyStyleSheets:function(_170,_171){
if(null==_170&&null==_171){
return;
}
var _172=0;
var _173=null;
if(_171.styleSheets.length==0){
if(_171.createStyleSheet){
_171.createStyleSheet();
}else{
css=_171.createElement("style");
css.media="all";
css.type="text/css";
var _174=_171.getElementsByTagName("head")[0];
_174.appendChild(css);
_173=css;
}
}
if(_171.styleSheets[0]){
_173=_171.styleSheets[0];
}
for(var i=0;i<_170.styleSheets.length;i++){
try{
var _176=_170.styleSheets[i];
var _177=_176.href;
var _178=false;
if(window.RadControlsNamespace.Browser.IsMozilla){
if(_176.ownerNode&&_176.ownerNode.tagName.toLowerCase()=="style"){
_178=true;
}
}
if(_177&&!_178){
...
var _179=(_176.rules)?_176.rules:_176.cssRules;
for(var j=0;j<_179.length;j++){
var _17b=_179[j];
if(_173.addRule){
var _17c=_17b.selectorText;
var oCss=_17b.style.cssText;
if(oCss&&_17c){
_173.addRule(_17c,oCss,_172);
}
}else{
if(_173.insertRule){
_173.insertRule(_17b.cssText,_172);
}else{
var oCss=_17b.selectorText+"{"+_17b.style.cssText+"}";
var _17e=_171.createTextNode(oCss);
_173.appendChild(_17e);
}
}
_172++;
}
...
var _17f=this.GetHiddenTextareaValue();
if(this.Mode==RadEditorNamespace.RADEDITOR_DESIGN_MODE||this.Mode==RadEditorNamespace.RADEDITOR_PREVIEW_MODE){
this.private_SetPageHtml(_17f);
}else{
if(RadEditorNamespace.RADEDITOR_HTML_MODE){
this.GetTextArea().value=_17f;
}
}
this.ValueSaved=false;
},private_EncodeHiddenAreaContent:function(_180){
if(_180){
this.FireEvent(RadEditorNamespace.RADEVENT_SUBMIT);
var _181=this.GetHtml(true);
var _182=this.SymbolsArray;
var oDiv=document.createElement("div");
for(var i=0;i<_182.length;i++){
oDiv.innerHTML=_182[i];
if(oDiv.innerHTML){
var _185=_181.split(oDiv.innerHTML);
_181=_185.join(_182[i]);
}
}
_181=TelerikNamespace.Utils.EncodePostbackContent(_181);
this.SetHiddenTextareaValue(_181);
}else{
var _186=TelerikNamespace.Utils.DecodePostbackContent(this.GetHiddenTextareaValue());
this.SetHiddenTextareaValue(_186);
}
},GetCssArrayForDocument:function(oDoc){
if(null==oDoc){
oDoc=document;
}
var _188=RadEditorNamespace.GetCssClassServer();
var _189=_188.GetCssArrayForDocument(oDoc);
var _189=this.GetFilteredCssClasses(_189);
return _189;
},GetCssClassesByTagName:function(oTag,_18b){
var _18c=RadEditorNamespace.GetCssClassServer();
var _18d=_18c.GetCssClassesByTagName(oTag,_18b);
_18d=this.GetFilteredCssClasses(_18d);
return _18d;
},GetFilteredCssClasses:function(_18e){
var _18f=[];
if(_18e&&this.CssFiltersObject){
for(var _190=0;_190<_18e.length;_190++){
var _191=_18e[_190];
if(outAlias=this.CheckCssFilter(_191.Rule.selectorText)){
_191.Alias=outAlias;
_18f[_18f.length]=_191;
}
}
return _18f;
}else{
...
},CheckCssFilter:function(_192){
if(!_192||!this.CssFiltersObject){
return null;
}
return this.CssFiltersObject[_192.replace(/(.*?)\./ig,function($1){
return $1.toUpperCase();
})];
},GetNamedCssForSelectedElement:function(oVal){
var _195=this.CheckCssFilter("."+oVal);
if(!_195){
var _196=this.GetSelection().GetParentElement();
if(_196&&_196.tagName){
_195=this.CheckCssFilter(_196.tagName+"."+oVal);
}
}
return _195;
},Fire:function(_197,_198){
if(false==this.ExecuteClientEvent("OnClientCommandExecuting",_197,_198)){
return;
}
if(!this.IsEditingEnabled()&&_197!="Undo"&&_197!="Redo"){
return;
}
if(this.IsIE){
...
var _199=RadEditorCommandList[_197];
var _19a=false;
if(_199){
_19a=(false!=_199(_197,this,_198));
}else{
alert("Could not find the command "+_197+". Please update your command list.");
}
if(_19a){
if(!this.IsOpera){
this.SetFocus();
...
this.ExecuteClientEvent("OnClientCommandExecuted",_197,_198);
},SetToolState:function(_19b){
...
var _19c=null;
var oCmd=null;
var _19e=this.ContentWindow;
for(var i=0;i<_19b.length;i++){
_19c=_19b[i];
var _1a0=_19c.Name;
oCmd=RadEditorNamespace.UpdateCommandsArray[_1a0];
if(_1a0==RadEditorNamespace.RADCOMMAND_UNDO){
_19c.SetState(this.CommandsManager.GetUndoState());
}else{
if(_1a0==RadEditorNamespace.RADCOMMAND_REDO){
_19c.SetState(this.CommandsManager.GetRedoState());
}else{
if(_1a0==RadEditorNamespace.RADCOMMAND_REPEAT_LAST_COMMAND){
_19c.SetState(this.CommandsManager.CanRepeatLastCommand()?RadEditorNamespace.RADCOMMAND_STATE_OFF:RadEditorNamespace.RADCOMMAND_STATE_DISABLED);
}else{
if(_19c.SetState&&oCmd&&oCmd.GetState){
_19c.SetState(oCmd.GetState(_19e));
}
}
}
}
if(_19c.UpdateValue){
_19c.UpdateValue(oCmd.GetValue(_19e));
}
_19c=oCmd=null;
}
...
this.CommandsManager.Undo(_1a2);
},Redo:function(_1a3){
this.CommandsManager.Redo(_1a3);
},MarkCurrentState:function(_1a4){
return RadEditorNamespace.RadGenericCommand.New(_1a4,this.ContentWindow);
},SaveCurrentState:function(_1a5){
this.ExecuteCommand(_1a5);
},ExecuteCommand:function(_1a6,_1a7,_1a8){
if(false!=_1a7&&!this.IsOpera){
this.SetFocus();
}
this.CommandsManager.Execute(_1a6,_1a8);
},ExecuteBrowserCommand:function(_1a9,_1aa,_1ab,_1ac){
var _1ad=this.Localization[_1a9];
this.ExecuteCommand(RadEditorNamespace.RadBrowserCommand.New(_1ad,_1a9,this.ContentWindow,_1ab));
this.SetActive();
this.SetFocus();
if(true==_1ac){
this.FireEvent(RadEditorNamespace.RADEVENT_SEL_CHANGED,null);
}
},ExecuteInsertObjectCommand:function(_1ae,_1af){
this.SetFocus();
return this.ExecuteCommand(RadEditorNamespace.RadPasteHtmlCommand.New(_1af,this.ContentWindow,RadEditorNamespace.Utils.GetOuterHtml(_1ae)));
},ExecuteFormatObjectCommand:function(_1b0,_1b1,_1b2){
return this.ExecuteCommand(RadEditorNamespace.RadFormatObjectCommand.New(_1b1,this.ContentWindow,_1b0,_1b2));
},ExecuteApplyCssClassCommand:function(_1b3,_1b4){
return this.ExecuteCommand(RadEditorNamespace.RadStyleCommand.New(_1b4,this.ContentWindow,_1b3));
},ExecuteSetAttributeCommand:function(_1b5,_1b6,_1b7,_1b8){
return this.ExecuteCommand(RadEditorNamespace.RadSetAttributeCommand.New(_1b8,this.ContentWindow,_1b5,_1b6,_1b7));
},ExecuteSetStyleRuleCommand:function(_1b9,_1ba,_1bb,_1bc){
return this.ExecuteCommand(RadEditorNamespace.RadSetStyleRuleCommand.New(_1bc,this.ContentWindow,_1b9,_1ba,_1bb));
},CreateElement:function(_1bd,_1be,_1bf,sId,_1c1,_1c2){
var _1c3=this.Document.createElement(_1bd);
_1c3.style.width=RadEditorNamespace.Utils.IsNull(_1be,"");
_1c3.style.height=RadEditorNamespace.Utils.IsNull(_1bf,"");
if(null!=sId){
_1c3.id=sId;
}
if(null!=_1c1){
...
return _1c3;
},SelectElement:function(_1c4,_1c5){
if(RadEditorNamespace.Utils.SelectElement(this.ContentWindow,_1c4)&&false!=_1c5){
this.FireEvent(RadEditorNamespace.RADEVENT_SEL_CHANGED,null);
}
...
},InsertLink:function(url,text,_1ca){
this.SetActive();
if(!_1ca){
_1ca={};
}
_1ca.href=url;
var _1cb=RadEditorNamespace.RadGenericCommand.New(this.Localization["CreateLink"],this.ContentWindow);
var oSel=this.GetSelection();
var _1cd;
var endR;
if(this.IsIE&&!oSel.IsControl()){
var _1cf=this.Document.selection.createRange();
_1cd=_1cf.duplicate();
endR=_1cf.duplicate();
_1cd.collapse();
endR.collapse(false);
}
var _1d0=RadEditorNamespace.Utils.GetElementParentByTag(oSel.GetParentElement(),"A");
var _1d1;
if(_1d0){
_1d1=_1d0;
this.SetLinkProperties(_1ca,"",_1d1);
}else{
...
var _1d2=RadEditorNamespace.MarkEditorSelection(this);
var _1d3=_1d2.markedElements;
for(var i=0;i<_1d3.length;i++){
var _1d5=_1d3[i];
if(null==_1d5.parentNode){
continue;
}
var _1d6=RadEditorNamespace.Utils.GetElementParentByTag(_1d5,"A");
if(_1d6){
if(_1d6.href!=_1ca.href){
this.SetLinkProperties(_1ca,"",_1d6);
}
continue;
}
var _1d1=this.Document.createElement("A");
_1d1.innerHTML=_1d5.innerHTML;
_1d5.innerHTML="";
if(this.IsSafari){
_1d1.href="#";
}
_1d5.appendChild(_1d1);
this.SetLinkProperties(_1ca,"",_1d1);
}
var _1d7=_1d2.newElements;
for(var i=0;i<_1d7.length;i++){
if(this.IsIE||this.IsOpera){
_1d7[i].removeNode(false);
}else{
var _1d8=document.createRange();
_1d8.selectNodeContents(_1d7[i]);
var _1d9=_1d8.extractContents();
_1d8.selectNode(_1d7[i]);
_1d8.deleteContents();
_1d8.insertNode(_1d9);
}
}
}else{
var _1da="editor__tmp__id";
this.PasteHtml("<a href='#' id = '"+_1da+"'>"+_1ca.text+"</a>");
var _1d1=this.Document.getElementById(_1da);
_1d1.removeAttribute("id");
_1ca.text=(_1ca.text||_1ca.href||_1ca.mail);
this.SetLinkProperties(_1ca,"",_1d1);
}
}
if(this.IsIE){
try{
var _1db=this.Document.selection.createRange();
_1db.setEndPoint("StartToStart",_1cd);
_1db.setEndPoint("EndToEnd",endR);
_1db.select();
}
catch(e){
}
}else{
var _1dc=this.ContentWindow.getSelection();
if(!this.IsSafari){
var rng=_1dc.getRangeAt(0);
rng.collapse(true);
}
}
this.ExecuteCommand(_1cb);
this.FireEvent(RadEditorNamespace.RADEVENT_SEL_CHANGED,null);
},SetLinkProperties:function(_1de,_1df,_1e0){
_1df=_1df||this.Localization[RadEditorNamespace.RADCOMMAND_SET_LINK_PROPERTIES];
var _1e1=this.GetSelectedElement();
var _1e0=_1e0||RadEditorNamespace.Utils.GetElementParentByTag(_1e1,"A");
var _1e2=this.Document.createElement("A");
var _1e3=["href","name","title","target","className"];
for(var i=0;i<_1e3.length;i++){
if(_1de[_1e3[i]]&&RadEditorNamespace.Utils.Trim(_1de[_1e3[i]])){
_1e2[_1e3[i]]=_1de[_1e3[i]];
}
}
if(_1de.text&&RadEditorNamespace.Utils.Trim(_1de.text)){
_1e0.innerHTML=_1de.text;
}
var _1e5=_1e0.innerHTML;
if(this.IsIE){
_1e0.clearAttributes();
_1e0.mergeAttributes(_1e2);
}else{
this.ExecuteFormatObjectCommand(_1e2,_1df,_1e0);
}
if(!_1e0.href){
_1e0.removeAttribute("href");
}
_1e0.innerHTML=_1e5;
if(this.IsIE&&_1e2.name){
_1e0.removeAttribute("name");
_1e0.removeAttribute("NAME");
_1e0.name=null;
_1e0.name=_1e2.name;
_1e0["NAME"]=_1e2.name;
this.Document.execCommand("CreateBookmark",false,_1e2.name);
}
var _1e6=_1e0.getElementsByTagName("IMG");
for(var i=0;i<_1e6.length;i++){
if(!_1e6[i].style.border&&!_1e6[i].border){
_1e6[i].border=0;
}
}
try{
this.SelectElement(_1e0,false);
}
catch(e){
}
this.SetFocus();
},InsertRow:function(_1e7){
var _1e8="Insert row";
if(_1e7=="above"){
_1e8=this.Localization[RadEditorNamespace.RADCOMMAND_INSERT_ROW_ABOVE];
}else{
if(_1e7=="below"){
_1e8=this.Localization[RadEditorNamespace.RADCOMMAND_INSERT_ROW_BELOW];
}
}
this.ExecuteCommand(RadEditorNamespace.RadTableInsertRow.New(_1e8,this.ContentWindow,_1e7));
},InsertColumn:function(_1e9){
var _1ea="Insert column";
if(_1e9=="left"){
_1ea=this.Localization[RadEditorNamespace.RADCOMMAND_INSERT_COLUMN_LEFT];
}else{
if(_1e9=="right"){
_1ea=this.Localization[RadEditorNamespace.RADCOMMAND_INSERT_COLUMN_RIGHT];
}
}
this.ExecuteCommand(RadEditorNamespace.RadTableInsertColumn.New(_1ea,this.ContentWindow,_1e9));
},DeleteRow:function(){
...
},AddShortcut:function(_1eb,_1ec){
if(this.KeyboardManager){
this.KeyboardManager.AddShortcut(_1eb,_1ec);
}
},RemoveShortcut:function(_1ed){
if(this.KeyboardManager){
this.KeyboardManager.RemoveShortcut(_1ed);
}
},SetShortcut:function(_1ee,_1ef){
if(this.KeyboardManager){
this.KeyboardManager.SetShortcut(_1ee,_1ef);
}
},GetDialogParameters:function(_1f0){
var args=null;
var _1f2=this.DialogParametersArray;
for(var i=0;i<_1f2.length;i++){
var _1f4=_1f2[i];
if(_1f0==_1f4[0]){
args={};
dialogArguments=_1f4[1];
...
return args;
},ShowDialog:function(url,_1f7,_1f8,_1f9,_1fa,_1fb,_1fc){
var re=this;
if(!_1fb){
_1fb={};
}
_1fb.editor=this;
_1fb.rngSelection=this.GetSelection().GetRange();
_1fb.callBackFn=_1fa;
...
var _1fe=this.Id;
_1f7.editorID=_1fe;
_1f7.HideEditorStatusBar=RadEditorNamespace.HideEditorStatusBar;
_1f7.ColorsArray=this.ColorsArray;
_1f7.CanAddCustomColors=this.AllowCustomColors;
_1f7.StripAbsoluteImagesPaths=this.StripAbsoluteImagesPaths;
_1f7.CommonInternalParameters=this.GetDialogInternalParameters("CommonDialogParameters");
RadEditorNamespace.ShowEditorStatusBar(_1fe);
window.setTimeout("RadEditorNamespace.HideEditorStatusBar('"+_1fe+"')",1000);
var rwi=new RadWindowInfo();
rwi.Url=url;
rwi.Width=_1f8;
rwi.Height=_1f9;
rwi.Caption=(_1fc?_1fc:"");
rwi.IsVisible=true;
rwi.Argument=_1f7;
rwi.CallbackFunc=function(_200,_201){
window.setTimeout(function(){
_201.editor.GetSelection().SelectRange(_201.rngSelection);
_201.editorID=null;
_201.CanAddCustomColors=null;
_201.StripAbsoluteImagesPaths=null;
if(_201.callBackFn){
var oRes=_201.callBackFn(_200,_201);
if(false==oRes){
return;
}
_201.editor.SetEditable(true);
}
if(null!=_200){
_201.editor.FireEvent(RadEditorNamespace.RADEVENT_SEL_CHANGED,null);
}
_201.editor.SetFocus();
},50);
};
rwi.OnLoadFunc=null;
rwi.Param=_1fb;
...
},GetDialogUrl:function(_206){
var url="";
if(this.UseSession==RadEditorNamespace.DIALOG_PARAMETERS_MODE_SESSION){
var _208=this.RadControlsDir.substr(this.ApplicationPath.length);
url=this.ApplicationPath+this.SessionID1+_208;
}else{
url=this.RadControlsDir;
}
var _209=url+"Editor/Dialog.aspx?dialog="+_206+"&editorID="+this.Id+"&useSession="+this.UseSession+"&sessionID2="+this.SessionID2+"&language="+this.Language+"&UseEmbeddedScripts="+this.UseEmbeddedScripts;
var _20a=this.GetDialogParameters(_206);
for(var _20b in _20a){
_209+="&"+_20b+"="+_20a[_20b];
}
return _209;
},GetDialogInternalParameters:function(_20c){
return this.DialogInternalParameters[_20c];
},_fixIEVisibilityProblems:function(_20d){
if(!this.IsIE){
return;
}
if(_20d){
var _20e=this.WrapperElement;
var _20f=RadEditorNamespace.Utils.GetInvisibleParent(_20e);
if(_20f){
this._onIEParentVisibilityChangeDelegate=this.RadEditorCreateDelegate(this,this._onIEParentVisibilityChange);
this._invisibleParent=_20f;
...
},_fixMozillaDOMProblems:function(_210){
if(this.IsIE){
return;
}
if(_210){
var _211=document.getElementById(this.Id+"_wrapper");
var _212=RadEditorNamespace.Utils.GetInvisibleParent(_211);
if(_212){
this._invisibleParent=_212;
this._onMozillaParentVisibilityChangeDelegate=this.RadEditorCreateDelegate(this,this._onMozillaParentVisibilityChange);
_212.addEventListener("DOMAttrModified",this._onMozillaParentVisibilityChangeDelegate,false);
}
...
if(e.attrName=="style"){
var _215=e.target;
if(_215.style.display!="none"){
}
}
},_onMozillaParentNodeChanged:function(e){
var _217=document.getElementById(this.Id+"_wrapper");
if(!e.target||!_217){
return;
}
var _218=RadEditorNamespace.Utils.IsDescendantOrSelf(e.target,_217);
if(_218){
this.OnParentNodeChanged();
}
},SetToolbarsWidth:function(){
return;
var _219=this.GetToolbars();
for(var i=0;i<_219.length;i++){
_219[i].SetToolbarWidth();
}
},RadEditorCreateDelegate:function(_21b,_21c){
return function(){
return _21c.apply(_21b,arguments);
};
...
if(!this.TextIframe){
var _21e=this.GetContentAreaElement();
if(_21e){
this.TextIframe=_21e.cloneNode(true);
this.TextIframe.style.position="absolute";
var _21f=this.TextIframe.style;
_21f.height="2px";
_21f.width="2px";
this.ContentTextarea.parentNode.appendChild(this.TextIframe);
var doc=this.TextIframe.contentWindow.document;
doc.designMode="off";
var _221=doc.open("text/html","replace");
var _222="<html style='height:100%;'><head><title>New Document</title></head>"+"<body style='overflow:hidden;margin:0px;padding:0px;height:100%'>"+"<textarea style='font:normal 11px Tahoma;color: #000080;border:0px;height:100%;width:100%'>"+"</textarea></body></html>";
...
var _224=this._getViewportBounds();
this.SetSize(_224.width,_224.height,false);
},_registerWindowResizeHandler:function(_225){
if(_225){
...
var _226=this.getClientBounds();
var _227=document.documentElement.scrollLeft||document.body.scrollLeft;
var _228=document.documentElement.scrollTop||document.body.scrollTop;
_226.scrollLeft=_227;
_226.scrollTop=_228;
return _226;
},_handleParentsWithOverflow:function(_229){
if(false==_229){
if(!this._parentsWithOverflow){
return;
}
var _22a=this._parentsWithOverflow;
var _22b=_22a.length;
for(var i=0;i<_22b;i++){
var _22d=_22a[i];
if(_22d[0]){
var node=_22d[0];
node.style.overflow=_22d[1];
node.style.height=_22d[2];
}
}
...
var _22a=this._parentsWithOverflow;
var _22f=this.WrapperElement.parentNode;
while(_22f&&_22f.tagName!="BODY"){
var _230=RadEditorNamespace.Utils.GetComputedStyle(_22f,"overflow");
if(_230){
_22a[_22a.length]=[_22f,_22f.style.overflow,_22f.style.height];
_22f.style.overflow="visible";
_22f.style.height="auto";
}
_22f=_22f.parentNode;
}
}
},toggleScreenMode:function(){
var _231=this;
if(!_231.ToggleFullScreen){
document.body.scroll="no";
document.body.style.margin="0px";
if(document.documentElement){
document.documentElement.style.overflow="hidden";
}
var _232=_231.WrapperElement;
_231._preFullScreenBounds=_231.getBounds(_232);
_231._handleParentsWithOverflow(true);
_231._onWindowResize();
_231._preFullScreenBrowserRect=_231._getViewportBounds();
var _233=_231.getLocationWithScrollOffset(_232);
RadEditorNamespace.RestoreBrowserPosition(_233.x,_233.y);
_231.ToggleFullScreen=true;
_231._registerWindowResizeHandler(true);
}else{
_231._registerWindowResizeHandler(false);
...
_231.ToggleFullScreen=false;
_231._handleParentsWithOverflow(false);
var _234=_231._preFullScreenBounds;
_231.SetSize(_234.width,_234.height,false);
var _233=_231._preFullScreenBrowserRect;
RadEditorNamespace.RestoreBrowserPosition(_233.scrollLeft,_233.scrollTop);
}
_231.SetEditable(true);
_231.SetFocus();
var _235=_231.GetToolByName(RadEditorNamespace.RADCOMMAND_TOGGLE_SCREEN_MODE);
if(_235){
_235.SetState(_231.ToggleFullScreen?RadEditorNamespace.RADCOMMAND_STATE_ON:RadEditorNamespace.RADCOMMAND_STATE_OFF);
}
if(_231.ToggleFullScreen){
_231.Fire(RadEditorNamespace.RADCOMMAND_TOGGLE_DOCKING);
if(true==_231.IsToolbarModeEnabled(RadEditorNamespace.ToolbarModesEnum.PageTop)||true==_231.IsToolbarModeEnabled(RadEditorNamespace.ToolbarModesEnum.ShowOnFocus)){
var _236=_231.IsToolbarModeEnabled(RadEditorNamespace.ToolbarModesEnum.PageTop)?RadEditorNamespace.GetPageTopToolbarManager():RadEditorNamespace.GetShowOnFocusToolbarManager();
if(_236){
var _237=_236.GetToolbarByEditor(_231);
if(_237){
_236.ShowToolbarHolder(false);
_237.parentNode.removeChild(_237);
_231.GetDockingZoneById("Top").appendChild(_237);
}
}
}
}else{
...
if(_236){
var _237=_236.GetToolbarByEditor(_231);
if(_237&&_237.parentNode){
_237.parentNode.removeChild(_237);
}
_236.CurrentEditor=null;
_231.SetFocus();
}
}
}
...
_238=document.documentElement.clientWidth;
_239=document.documentElement.clientHeight;
}else{
_238=document.body.clientWidth;
_239=document.body.clientHeight;
}
}else{
if(this.IsSafari){
_238=window.innerWidth;
_239=window.innerHeight;
}else{
if(this.IsOpera){
_238=Math.min(window.innerWidth,document.body.clientWidth);
_239=Math.min(window.innerHeight,document.body.clientHeight);
}else{
_238=Math.min(window.innerWidth,document.documentElement.clientWidth);
_239=Math.min(window.innerHeight,document.documentElement.clientHeight);
}
}
}
return {x:0,y:0,width:_238,height:_239};
},getLocationWithScrollOffset:function(_23a){
var _23b=null;
var pos=[];
var box;
if(_23a.getBoundingClientRect){
box=_23a.getBoundingClientRect();
var _23e=document.documentElement.scrollTop||document.body.scrollTop;
var _23f=document.documentElement.scrollLeft||document.body.scrollLeft;
var x=box.left+_23f-2;
var y=box.top+_23e-2;
return {x:x,y:y};
}else{
if(document.getBoxObjectFor){
box=document.getBoxObjectFor(_23a);
pos=[box.x-1,box.y-1];
}else{
pos=[_23a.offsetLeft,_23a.offsetTop];
_23b=_23a.offsetParent;
if(_23b!=_23a){
while(_23b){
pos[0]+=_23b.offsetLeft;
pos[1]+=_23b.offsetTop;
...
if(window.opera){
_23b=_23a.offsetParent;
while(_23b&&_23b.tagName.toUpperCase()!="BODY"&&_23b.tagName.toUpperCase()!="HTML"){
pos[0]-=_23b.scrollLeft;
pos[1]-=_23b.scrollTop;
_23b=_23b.offsetParent;
}
}else{
_23b=_23a.parentNode;
while(_23b&&_23b.tagName.toUpperCase()!="BODY"&&_23b.tagName.toUpperCase()!="HTML"){
pos[0]-=_23b.scrollLeft;
pos[1]-=_23b.scrollTop;
...
},getBounds:function(_242){
var _243=this.getLocationWithScrollOffset(_242);
return {x:_243.x,y:_243.y,width:_242.offsetWidth||0,height:_242.offsetHeight||0};
...
RadEditorNamespace.StripScriptsFilter.prototype={GetHtmlContent:function(_1){
return this._performStripping(_1);
},GetDesignContent:function(_2){
return this._performStripping(_2);
},_performStripping:function(_3){
var _4=_3.replace(new RegExp("<(SCRIPT)([^>]*)/>","ig"),"");
_4=_4.replace(RegExp("<(SCRIPT)([^>]*)>[\\s\\S]*?</(SCRIPT)([^>]*)>","ig"),"");
return _4;
}};
...
RadEditorNamespace.EncodeScriptsFilter.prototype={GetHtmlContent:function(_5){
var _6=new RegExp("<!"+"--RADEDITORSAVEDTAG_([\\s\\S]*?)--"+">","ig");
var _7=new RegExp("--RADEDITORSAVEDTAGENDING>","ig");
var _8=_5.replace(_6,"<$1>");
_8=_8.replace(_7,"--"+">");
return _8;
},GetDesignContent:function(_9){
var _a=function(_b,_c,_d,_e,_f){
var _10=_f.substring(0,_e).lastIndexOf("<!"+"--");
var _11=_f.substring(0,_e).lastIndexOf("--"+">");
if(_10>_11){
_10=_f.substring(_e,_f.length).indexOf("<!"+"--");
_11=_f.substring(_e,_f.length).indexOf("--"+">");
if((_10==-1&&_11>-1)||(_11<_10)){
return _b;
}
}
var _12=_d.replace("--"+">","--RADEDITORSAVEDTAGENDING>");
var _13="<!"+"--RADEDITORSAVEDTAG_"+_c+_12+"--"+">";
return _13;
};
var _14=new RegExp("<(script|noscript)([\\s\\S]*?<\\/\\1)>","ig");
var _15=_9.replace(_14,_a);
return _15;
}};
...
RadEditorNamespace.RemoveExtraBrakes.prototype={GetHtmlContent:function(_16){
return this._performStripping(_16);
},_performStripping:function(_17){
var _18=_17;
_18=_18.replace(/<BR\s?\/?>\s*<\/(H1|H2|H3|H4|H5|H6|LI|P)/ig,"</$1");
_18=_18.replace(/<(H1|H2|H3|H4|H5|H6|LI|P)([^>]*)?><BR\s?\/?>/ig,"<$1 $2>");
return _18;
}};
...
RadEditorNamespace.FixNestedLists.prototype={_getElements:function(_19,_1a){
var _1b=_19.getElementsByTagName(_1a);
if(!_1b){
_1b=_19.ownerDocument.getElementsByTagName(_1a);
}
return _1b;
},fixLists:function(_1c,_1d){
var _1e=this._getElements(_1c,_1d);
for(var i=_1e.length-1;i>=0;i--){
var _20=_1e[i];
var _21=_20.previousSibling;
if(_21&&_21.nodeType==3){
_21=_21.previousSibling;
}
if(_21&&"li"==_20.previousSibling.nodeName.toLowerCase()){
_21.appendChild(_20.cloneNode(true));
var _22=_20.parentNode;
_22.removeChild(_20);
_22=null;
}
}
},GetHtmlContent:function(_23){
this.fixLists(_23,"OL");
this.fixLists(_23,"UL");
return _23;
}};
...
RadEditorNamespace.FixUlBoldItalic.prototype={_getElements:function(_24,_25){
var _26=_24.getElementsByTagName(_25);
if(!_26){
_26=_24.ownerDocument.getElementsByTagName(_25);
}
return _26;
},_replaceElementWithSpan:function(_27,_28,_29){
var _2a=this._getElements(_27,_28);
var _2b=[];
for(var j=_2a.length-1;j>=0;j--){
_2b[_2b.length]=_2a[j];
}
for(var i=0,len=_2b.length;i<len;i++){
var _2f=_27.ownerDocument.createElement("span");
_2f.style.cssText=_29;
var _30=_2b[i];
var _31=_30.innerHTML;
if(window.RadControlsNamespace.Browser.IsIE&&_31==" "){
_2f.innerText=_31;
}else{
RadEditorNamespace.Utils.setElementInnerHtml(_2f,_31);
}
_30.parentNode.replaceChild(_2f,_30);
}
},_replaceSpanWithElement:function(_32,_33,_34){
var _35=this._getElements(_32,"span");
var _36=[];
for(var j=_35.length-1;j>=0;j--){
_36[_36.length]=_35[j];
}
for(var i=0,len=_36.length;i<len;i++){
var _3a=[];
var _3b=_36[i];
for(var k=0;k<_3b.childNodes.length;k++){
_3a[_3a.length]=_3b.childNodes[k].cloneNode(true);
}
if(_3b.style.cssText.toLowerCase()==_34||_3b.style.cssText.toLowerCase()==(_34+";")){
var _3d=_32.ownerDocument.createElement(_33);
for(var l=0;l<_3a.length;l++){
_3d.appendChild(_3a[l]);
}
_3b.parentNode.replaceChild(_3d,_3b);
}
}
},GetHtmlContent:function(_3f){
this._replaceElementWithSpan(_3f,"u","text-decoration:underline;");
return _3f;
},GetDesignContent:function(_40){
this._replaceSpanWithElement(_40,"u","text-decoration: underline");
return _40;
}};
...
RadEditorNamespace.IEKeepCommentsFilter.prototype={GetHtmlContent:function(_41){
var _42=new RegExp("<!"+"--RADEDITORSAVEDCOMMENT","ig");
var _43=_41.replace(_42,"<!--");
return _43;
},GetDesignContent:function(_44){
var _45=new RegExp("<!"+"--(\\[[^]]+\\][\\s\\S]*?)-"+"->","ig");
var _46=_44.replace(_45,"<!-"+"-RADEDITORSAVEDCOMMENT$1-"+"->");
return _46;
}};
...
RadEditorNamespace.IEKeepObjectParamsFilter.prototype={GetHtmlContent:function(_47){
var _48=new RegExp("<param([\\s\\S]+?)?>","ig");
var _49=new RegExp("<rade_param([\\s>])","ig");
var _4a=_47;
if(_48.test(_47)&&_49.test(_47)){
_4a=_4a.replace(_48,"");
}
_4a=_4a.replace(_49,"<param$1");
_4a=_4a.replace(/<\/rade_param>/gi,"");
return _4a;
},GetDesignContent:function(_4b){
var _4c=new RegExp("<param([\\s\\S]+?)/?>","ig");
var _4d=_4b.replace(_4c,"<rade_param$1></rade_param><param$1>");
return _4d;
}};
...
RadEditorNamespace.FixEnclosingP.prototype={_removeNode:function(_4e){
var _4f=_4e.parentNode;
if(_4f!=null){
while(_4e.childNodes&&_4e.childNodes.length>0){
_4f.insertBefore(_4e.childNodes[0],_4e);
}
_4f.removeChild(_4e);
return _4f;
}
return true;
},GetHtmlContent:function(_50){
var _51=null;
if(_50.tagName.toLowerCase()=="html"){
_51=_50.getElementsByTagName("BODY")[0];
}else{
_51=_50;
}
if(window.RadControlsNamespace.Browser.IsIE){
if(_51&&(_51.firstChild)&&("P"==_51.firstChild.tagName)&&(_51.childNodes.length==1)&&(_51.innerHTML.substring(0,3).toLowerCase()=="<p>")){
this._removeNode(_51.firstChild);
}
}else{
if(_51&&(_51.childNodes.length==1)&&(_51.firstChild.tagName)&&("br"==_51.firstChild.tagName.toLowerCase())){
_51.innerHTML="";
}
}
return _50;
...
RadEditorNamespace.IEFixEmptyParagraphs.prototype={GetHtmlContent:function(_52){
var re=new RegExp("(<p[^>]*>)(<\\/p>)","ig");
var _54=_52.replace(re,"$1&nbsp;$2");
return _54;
}};
...
RadEditorNamespace.IECleanAnchorsFilter.prototype={GetHtmlContent:function(_55){
var _56=document.location.href;
var re=new RegExp("(<A[^<>]*?(href)\\s*=\\s*['\"])("+_56+")(\\#[^'\"]*?['\"][^>]*?>)","ig");
var _58=_55.replace(re,"$1$4");
return _58;
}};
...
RadEditorNamespace.MozEmStrongFilter.prototype={GetHtmlContent:function(_59){
var _5a=_59.replace(new RegExp("<b(\\s([^>])*?)?>","ig"),"<strong$1>");
_5a=_5a.replace(new RegExp("</b(\\s([^>])*?)?>","ig"),"</strong$1>");
_5a=_5a.replace(new RegExp("<i(\\s([^>])*?)?>","ig"),"<em$1>");
_5a=_5a.replace(new RegExp("</i(\\s([^>])*?)?>","ig"),"</em$1>");
return _5a;
},GetDesignContent:function(_5b){
var _5c=_5b.replace(new RegExp("<strong(\\s([^>])*?)?>","ig"),"<b$1>");
_5c=_5c.replace(new RegExp("</strong(\\s([^>])*?)?>","ig"),"</b$1>");
_5c=_5c.replace(new RegExp("<em(\\s([^>])*?)?>","ig"),"<i$1>");
_5c=_5c.replace(new RegExp("</em(\\s([^>])*?)?>","ig"),"</i$1>");
return _5c;
}};
...
RadEditorNamespace.MozillaKeepStylesString.prototype={GetDesignContent:function(_5d){
var _5e=this;
var _5f=function(_60,_61,_62,_63,_64){
var _65=_64.indexOf("</head>",_63);
if(_65!=-1&&_64.indexOf("<body",_65)!=-1){
return _60;
}else{
_5e.markerCounter++;
var _66="RadEditorStyleKeeper"+_5e.markerCounter;
var _67="<div id='"+_66+"' style='display:none;'>&nbsp;</div><"+_61+" reoriginalpositionmarker='"+_66+"'"+_62;
return _67;
}
};
var _68=new RegExp("<(link|style)([^>]*>)","gi");
var _69=_5d.replace(_68,_5f);
return _69;
}};
...
RadEditorNamespace.MozillaKeepStylesDom.prototype={GetHtmlContent:function(_6a){
var _6b=_6a.getElementsByTagName("HEAD")[0];
var _6c=true;
if(!_6b){
_6b=_6a.ownerDocument.getElementsByTagName("HEAD")[0];
_6c=false;
}
if(!_6b){
return _6a;
}
this._restoreElements(_6b,_6a,"STYLE");
this._restoreElements(_6b,_6a,"LINK");
var _6d=_6a.getElementsByTagName("DIV");
if(_6d){
for(var j=_6d.length-1;j>=0;j--){
var _6f=_6d[j];
if(_6f.id.indexOf("RadEditorStyleKeeper")==0){
var _70=_6f.parentNode;
_70.removeChild(_6f);
}
}
}
_6d=null;
if(_6c){
this._removeElements(_6b,"STYLE");
this._removeElements(_6b,"LINK");
}
this._removeMarkerAttributes(_6a,"STYLE");
this._removeMarkerAttributes(_6a,"LINK");
return _6a;
},_restoreElements:function(_71,_72,_73){
var _74;
_74=_71.getElementsByTagName(_73);
this._divs=_72.getElementsByTagName("DIV");
var i=0;
while(_74.length>0&&i<_74.length){
this._restoreStyle(_74[i++]);
}
},_restoreStyle:function(_76){
var _77=_76.getAttribute("reoriginalpositionmarker");
if(_77){
j=0;
var _78=null;
while(j<this._divs.length&&!_78){
if(this._divs[j].id==_77){
_78=this._divs[j];
}
j++;
}
if(_78){
var _79=_76.cloneNode(true);
_79.removeAttribute("reoriginalpositionmarker");
var _7a=_78.parentNode;
_7a.replaceChild(_79,_78);
return true;
}
}
return false;
},_removeElements:function(_7b,_7c){
var _7d=_7b.getElementsByTagName(_7c);
if(_7d){
for(var j=_7d.length-1;j>=0;j--){
var _7f=_7d[j];
if(null!=_7f.getAttribute("reoriginalpositionmarker")){
...
},_removeMarkerAttributes:function(_81,_82){
styles=_81.getElementsByTagName(_82);
if(styles){
...
RadEditorNamespace.MozillaKeepFlashString=function(_84){
this.IsDom=false;
this.Enabled=true;
...
this._flashImageSrc=_84?_84:"FlashManager.gif";
};
RadEditorNamespace.MozillaKeepFlashString.prototype={GetDesignContent:function(_85){
var _86=this._flashImageSrc;
var _87=function(_88,gr1,gr2,gr3,_8c,str){
var _8e=new RadEditorNamespace.Utils.StringBuilder("<img isflash=\"true\" ");
_8e.append(gr1.replace(/\ssrc=/gi," src=\""+_86+"\" flashSrc="));
_8e.append(" />");
return _8e.toString();
};
var _8f=new RegExp("<embed([^>]+)>?","ig");
var _90=_85.replace(_8f,_87);
_90=_90.replace(/<\/embed>/ig,"");
return _90;
}};
...
RadEditorNamespace.MozillaKeepFlash.prototype={GetHtmlContent:function(_91){
var _92=_91.getElementsByTagName("IMG");
for(var i=0;i<_92.length;i++){
var _94=_92[i];
var _95=_94.getAttribute("isflash");
if(_95!=null){
var _96=_94.getAttribute("flashSrc");
var _97=RadEditorNamespace.Utils.GetOuterHtml(_94);
_97=_97.replace(/<img/gi,"<embed");
var _98=_94.ownerDocument.createElement("DIV");
_98.innerHTML=_97;
newNode=_98.firstChild;
if(_96){
newNode.src=_96;
if(window.RadControlsNamespace.Browser.IsSafari){
newNode.setAttribute("src",_96);
}
}
newNode.removeAttribute("flashSrc");
newNode.removeAttribute("isflash");
var _99=_94.parentNode;
_99.insertBefore(newNode,_94);
_99.removeChild(_94);
i--;
}
}
...
RadEditorNamespace.StripJunkFilter.prototype={GetHtmlContent:function(_9a){
var _9b=_9a;
if(window.RadControlsNamespace.Browser.IsSafari){
_9b=_9b.replace(new RegExp(" class=\"khtml-block-placeholder\"","ig"),"");
_9b=_9b.replace(new RegExp(" class=\"Apple-style-span\"","ig"),"");
_9b=_9b.replace(new RegExp(" class=\"webkit-block-placeholder\"","ig"),"");
}
if(window.RadControlsNamespace.Browser.IsFirefox){
_9b=_9b.replace(new RegExp("\\s?<br type=\"_moz\" \\/>","ig")," ");
_9b=_9b.replace(new RegExp(" _moz_[a-z_]*=\"[^\"]*\"","ig"),"");
_9b=_9b.replace(new RegExp(" type=\"_moz\"","ig"),"");
}
return _9b;
}};
...
},GetHtmlContent:function(_9d){
var _9e=_9d.ownerDocument;
var _9f=_9e.createElement("SPAN");
var _a0,_a1,_a2;
var _a3=_9d.getElementsByTagName("FONT");
while(_a3.length>0){
_a1=_a3[0];
_a2=_a1.parentNode;
_a0=_9f.cloneNode(false);
RadEditorNamespace.Utils.MergeElementAttributes(_a1,_a0,false);
if(_a1.style.cssText&&_a1.style.cssText!=""){
_a0.style.cssText=_a1.style.cssText;
}
if(_a1.className){
_a0.className=_a1.className;
}
if(_a1.face){
_a0.style.fontFamily=_a1.face;
if(_a0.getAttribute("face")!=null){
_a0.removeAttribute("face");
}
}
var _a4=0;
if(_a1.style.fontSize){
_a0.style.fontSize=_a1.style.fontSize;
}else{
if(!isNaN(_a4=parseInt(_a1.size))&&_a1.size!="+0"){
try{
if(_a4<0){
_a4=_a4+4;
}
_a0.style.fontSize=this._fontSizes[_a4-1];
}
catch(ex){
_a0.style.fontSize=this._fontSizes[3];
}
if(_a0.getAttribute("size")!=null){
_a0.removeAttribute("size");
}
}
}
if(_a1.color){
_a0.style.color=_a1.color;
if(_a0.getAttribute("color")!=null){
_a0.removeAttribute("color");
}
}
if(window.RadControlsNamespace.Browser.IsIE&&_a1.innerHTML==" "){
_a0.innerText=_a1.innerHTML;
}else{
RadEditorNamespace.Utils.setElementInnerHtml(_a0,_a1.innerHTML);
}
_a2.replaceChild(_a0,_a1);
_a3=_9d.getElementsByTagName("FONT");
}
return _9d;
},GetDesignContent:function(_a5){
var _a6=_a5.ownerDocument;
var _a7=_a6.createElement("FONT");
var _a8,_a9,_aa;
var _ab=_a5.getElementsByTagName("SPAN");
while(_ab.length>0){
_a8=_ab[0];
_aa=_a8.parentNode;
_a9=_a7.cloneNode(false);
RadEditorNamespace.Utils.MergeElementAttributes(_a8,_a9,false);
if(_a8.style.cssText&&_a8.style.cssText!=""){
_a9.style.cssText=_a8.style.cssText;
}
if(_a8.className){
_a9.className=_a8.className;
}
if(_a8.style.fontFamily){
_a9.face=_a8.style.fontFamily;
this._removeElementStyleAttribute(_a9,"fontFamily");
}
if(_a8.style.fontSize){
var _ac=3;
var _ad=null;
if(-1!=_a8.style.fontSize.indexOf("pt")){
_ad=this._fontSizesRev[parseInt(_a8.style.fontSize)];
}
if(typeof (_ad)!="undefined"&&null!=_ad){
_a9.size=_ad+1;
this._removeElementStyleAttribute(_a9,"fontSize");
}
}
if(_a8.style.color){
_a9.color=this._fixColorValue(_a8.style.color);
this._removeElementStyleAttribute(_a9,"color");
}
if(window.RadControlsNamespace.Browser.IsIE&&_a8.innerHTML==" "){
_a9.innerText=_a8.innerHTML;
}else{
RadEditorNamespace.Utils.setElementInnerHtml(_a9,_a8.innerHTML);
}
_aa.replaceChild(_a9,_a8);
_ab=_a5.getElementsByTagName("SPAN");
}
return _a5;
},_fixColorValue:function(_ae){
if(_ae.toLowerCase().indexOf("rgb")!=-1){
var _af="#";
var _b0=function(val){
var _b2=parseInt(val,10).toString(16);
_af=_af+(_b2.length==1?"0"+_b2:_b2);
return val;
};
_ae=_ae.replace(/(\d+)/gi,_b0);
_b0=null;
return _af;
}else{
return _ae;
}
},_removeElementStyleAttribute:function(_b3,_b4){
if(_b3.style&&_b3.style[_b4]){
if(_b3.style.removeAttribute){
_b3.style.removeAttribute(_b4);
}else{
if(_b3.style.removeProperty){
_b4=_b4.replace(/([A-Z])/g,"-$1").toLowerCase();
_b3.style.removeProperty(_b4);
}
}
if(_b3.style[_b4]){
_b3.style[_b4]=null;
}
if(_b3.style.cssText){
}else{
_b3.removeAttribute("style");
}
}
}};
...
},GetHtmlContent:function(_b5){
if(!_b5){
return "";
}
var sb=new RadEditorNamespace.Utils.StringBuilder("");
this._appendNodeXhtml(_b5,sb);
return sb.toString();
},_convertAttribute:function(s){
return String(s).replace(/\&/g,"&amp;").replace(/</g,"&lt;").replace(/>/g,"&gt;").replace(/\"/g,"&quot;");
},_getAttributeValue:function(_b8,_b9,sb){
var _bb=_b8.nodeName;
var _bc=_b8.nodeValue;
if(_bb!="style"){
if(window.RadControlsNamespace.Browser.IsIE&&(_bb=="type"||_bb=="value"||_bb=="selected")){
if(!_bc){
return;
}
}else{
if(!_b8.specified){
if(window.RadControlsNamespace.Browser.IsIE&&_bc==""&&typeof (_b9[_bb])=="string"&&_b9[_bb]!=""){
_bc=_b9[_bb];
}else{
return;
}
...
if(!isNaN(_bc)){
_bc=_b9.getAttribute(_bb);
}
if(window.RadControlsNamespace.Browser.IsIE&&(_bb=="href"||_bb=="src")){
_bc=_b9.getAttribute(_bb,2);
}
sb.append(" "+(_b8.expando?_bb:_bb.toLowerCase())+"=\""+this._convertAttribute(_bc)+"\"");
}else{
var _bd=_b9.style.cssText;
if(_bd){
sb.append(" style=\""+this._convertAttribute(_bd.toLowerCase())+"\"");
}
}
},_canHaveChildren:function(_be){
...
return true;
},_appendElementNode:function(_bf,sb){
if(_bf.tagName.charAt(0)=="/"){
return;
}
if(_bf.nodeName=="!"){
sb.append(_bf.text);
...
var _c1=_bf.nodeName;
if(_bf.scopeName){
if(_bf.scopeName=="HTML"){
_c1=_c1.toLowerCase();
}else{
_c1=_bf.scopeName+":"+_c1;
}
}else{
_c1=_c1.toLowerCase();
}
...
if("img"==_c1){
if(window.RadControlsNamespace.Browser.IsIE){
var _c2=document.createElement("IMG");
_c2.mergeAttributes(_bf);
if(_c2.width){
sb.append(" width=\""+_bf.getAttribute("width",2)+"\"");
}
if(_c2.height){
sb.append(" height=\""+_bf.getAttribute("height",2)+"\"");
}
}
if(_bf.getAttribute("alt",2)==""){
sb.append(" alt=\"\"");
}
}
if(window.RadControlsNamespace.Browser.IsIE&&("area"==_c1||"a"==_c1)){
if(_bf.shape){
sb.append(" shape=\""+_bf.shape.toLowerCase()+"\"");
}
if(_bf.coords){
sb.append(" coords=\""+_bf.getAttribute("coords")+"\"");
}
var _c3=_bf.getAttribute("href",2);
if(_c3){
_c3=_c3.replace("about:blank","");
_c3=_c3.replace("about:","");
_c3=_c3.replace(/&amp;/gi,"&").replace(/&/gi,"&amp;");
sb.append(" href=\""+_c3+"\"");
_bf.removeAttribute("href",0);
}
}
try{
var _c4=_bf.attributes;
var l=_c4.length;
for(var i=0;i<l;i++){
this._getAttributeValue(_c4[i],_bf,sb);
}
}
catch(exc){
}
switch(_c1){
case "script":
sb.append(">"+_bf.text+"</"+_c1+">");
break;
case "textarea":
sb.append(">"+_bf.value+"</"+_c1+">");
break;
case "iframe":
sb.append("></iframe>");
break;
...
if(window.RadControlsNamespace.Browser.IsIE){
_c7=_c7.replace(/\soriginalAttribute="[^"]+"/gi,"");
_c7=_c7.replace(/\soriginalPath="[^"]+"/gi,"");
}
sb.append(_c7);
sb.append("</object>");
break;
...
case "comment":
case "noscript":
var _c7=_bf.innerHTML;
if(window.RadControlsNamespace.Browser.IsIE&&_c7.length==0){
_c7=_bf.ownerDocument.title;
}
sb.append(">"+_c7+"</"+_c1+">");
break;
default:
if(_bf.hasChildNodes()||(true==_bf.canHaveChildren||(_bf.canHaveChildren==null&&this._canHaveChildren(_bf)))){
sb.append(">");
var cs=_bf.childNodes;
l=cs.length;
for(var i=0;i<l;i++){
...
},_appendTextNode:function(_c9,sb){
var _cb=String(_c9.nodeValue);
var _cc=_c9.parentNode.nodeName.toLowerCase();
if(!window.RadControlsNamespace.Browser.IsIE&&(_cc=="style"||_cc=="script")){
sb.append(_cb);
}else{
_cb=_cb.replace(/\&/g,"&amp;").replace(/</g,"&lt;").replace(/>/g,"&gt;");
if(window.RadControlsNamespace.Browser.IsFirefox){
_cb=_cb.replace(/[\u00a0]/g,"&nbsp;");
}
sb.append(_cb);
}
},_appendCDataNode:function(_cd,sb){
sb.append("<![CDA"+"TA[\n"+_cd.nodeValue+"\n]"+"]>");
},_appendCommentNode:function(_cf,sb){
var _d1=_cf.nodeValue;
if(!_d1&&_cf.text){
_d1=_cf.text;
}else{
_d1="<!--"+_d1+"-->";
...
sb.append(_d1);
},_appendNodeXhtml:function(_d2,sb){
if(_d2.uniqueID){
if(this._uniqueIds[_d2.uniqueID]){
return;
}else{
this._uniqueIds[_d2.uniqueID]=true;
}
}
switch(_d2.nodeType){
case 1:
this._appendElementNode(_d2,sb);
break;
case 3:
this._appendTextNode(_d2,sb);
break;
case 4:
this._appendCDataNode(_d2,sb);
break;
case 8:
this._appendCommentNode(_d2,sb);
break;
}
}};
...
var _d4="P|DIV|H1|H2|H3|H4|H5|H6|ADDRESS|PRE|OL|UL|LI|TITLE|META|LINK|BASE|SCRIPT|LINK|TD|TH|AREA|OPTION";
var _d5="HTML|HEAD|BODY|STYLE|FORM|TABLE|TBODY|THEAD|TR";
var _d6=_d5+"|UL|OL";
this._ignoreTags=new RegExp("(<PRE[^>]*>|<!--|<SCRIPT[^>]*>)([\\s\\S]*?)(<\\/PRE>|-->|<\\/SCRIPT>)","gi");
this._tagsNLBefore=new RegExp("<("+_d4+")[^>]*>","gi");
this._tagsNLAfter=new RegExp("<\\/("+_d4+")[^>]*>","gi");
this._tagsNLNoCloseAfter=new RegExp("<(BR|HR)[^>]*\\/?>","gi");
this._tagsNLBeforeAndAfter=new RegExp("<\\/?("+_d5+")[^>]*>","gi");
this._tagsIncIndent=new RegExp("^<("+_d6+")[\\s\\/>]","i");
this._tagsDecIndent=new RegExp("^<\\/("+_d6+")[\\s\\>]","i");
this._shrinkNL=new RegExp("\\s*\\n+\\s*","gi");
};
RadEditorNamespace.IndentHTMLContentFilter.prototype={dispose:function(){
this._protectedData=[];
},GetHtmlContent:function(_d7){
var _d8=RadEditorNamespace.Utils.Trim(_d7);
if(_d8.indexOf("<body")==0){
_d8=_d8.substring(_d8.indexOf(">")+1,_d8.length-7);
}
this._protectedData=[];
var _d9=this;
var _da=function(_db,_dc,_dd,_de,_df,_e0){
_d9._protectedData[_d9._protectedData.length]=_dd;
return _dc+"RADEDITORFORMATTED_"+_d9._protectedData.length+_de;
};
_d8=_d8.replace(this._ignoreTags,_da);
var _e1="$&";
if(window.RadControlsNamespace.Browser.IsSafari2){
_e1="$0";
}
_d8=_d8.replace(this._tagsNLBefore,"\n"+_e1);
_d8=_d8.replace(this._tagsNLAfter,_e1+"\n");
_d8=_d8.replace(this._tagsNLNoCloseAfter,_e1+"\n");
_d8=_d8.replace(this._tagsNLBeforeAndAfter,"\n"+_e1+"\n");
var _e2=_d8.split(this._shrinkNL);
var _e3=new RadEditorNamespace.Utils.StringBuilder("");
var _e4="";
...
if(this._tagsDecIndent.test(_e6)){
if(_e4.length>this._indentPattern.length){
_e4=_e4.substring(this._indentPattern.length);
}else{
_e4="";
}
}
...
_e3.append(_e6);
_e3.append("\n");
if(this._tagsIncIndent.test(_e6)){
_e4+=this._indentPattern;
}
}
_d8=_e3.toString();
for(var i=0;i<this._protectedData.length;i++){
var _e7=new RegExp("RADEDITORFORMATTED_"+(i+1));
var _e8=this._protectedData[i].replace(/\$/gi,"$$$$");
_d8=_d8.replace(_e7,_e8);
}
return _d8;
}};
RadEditorNamespace.MakePathsAbsolute=function(_e9){
this.IsDom=true;
this.Enabled=true;
...
RadEditorNamespace.MakePathsAbsolute.prototype={GetHtmlContent:function(_ea){
if("href"==this.attrName){
this._updateElements(_ea,"A","href");
this._updateElements(_ea,"AREA","href");
}else{
if("src"==this.attrName){
this._updateElements(_ea,"IMG","src");
this._updateElements(_ea,"EMBED","src");
}
}
return _ea;
},_getElements:function(_eb,_ec){
var _ed=_eb.getElementsByTagName(_ec);
if(!_ed){
_ed=_eb.ownerDocument.getElementsByTagName(_ec);
}
return _ed;
},_updateElements:function(_ee,_ef,_f0){
var _f1=_ee.ownerDocument.createElement("div");
var _f2=this._getElements(_ee,_ef);
if(_f2){
for(var i=0;i<_f2.length;i++){
var _f4=_f2[i].getAttribute(_f0,2);
if("href"==_f0&&_f4){
_f1.innerHTML="<a href=\""+_f4.replace(/\"/gi,"%22")+"\">test</a>";
if(window.RadControlsNamespace.Browser.IsIE){
var _f5=_f2[i].innerHTML;
}
_f2[i].setAttribute("href",_f1.childNodes[0].href);
if(window.RadControlsNamespace.Browser.IsIE){
if((_f5.indexOf("www.")==0&&_f2[i].innerHTML.match("[a-z]+://"))||(_f5.indexOf("mailto:")==-1&&_f2[i].innerHTML.match("mailto:"))){
_f2[i].innerHTML=_f5;
}
}
}else{
if("src"==_f0&&_f4){
_f1.innerHTML="<img src=\""+_f4.replace(/\"/gi,"%22")+"\" />";
_f2[i].setAttribute("src",_f1.childNodes[0].src);
}
}
}
}
...
RadEditorNamespace.RadStripPathFilter=function(_f6,_f7){
this.Name="RadStripPathFilter";
this.Description="This filter strips an image or an anchor path";
this.TagName=_f6;
this.PathToStrip=_f7;
this.GetHtmlContent=function(_f8){
if(!document.all){
return _f8;
}else{
var _f9=StripAbsolutePaths(_f8,this.TagName,this.PathToStrip);
return _f9;
}
return _f8;
};
function StripAbsolutePaths(_fa,_fb,_fc){
var _fd=function(_fe,_ff,_100,_101){
_101=RadEditorNamespace.Utils.EscapeRegexSpecialChars(_101);
var _102=new RegExp("(<"+_ff+"[^<>]*?("+_100+")\\s*=\\s*['\"])("+_101+")([^'\"]*?['\"][^>]*?>)","ig");
return _fe.replace(_102,"$1$4");
};
var _103=function(_104,_105,_106){
if(_105=="A"){
var _107=document.location.href;
_107=RadEditorNamespace.Utils.EscapeRegexSpecialChars(_107);
var re=new RegExp("(<A[^<>]*?(href)\\s*=\\s*['\"])("+_107+")(\\#[^'\"]*?['\"][^>]*?>)","ig");
_104=_104.replace(re,"$1$4");
}
var _109=_104;
var _10a=(_105=="A"?"href":"src");
for(var i=0;i<_106.length;i++){
if(_106[i]){
_109=_fd(_109,_105,_10a,_106[i]);
}
}
return _109;
};
...
var _10d=window.location;
_10c[0]=_10d.protocol+"//"+_10d.host+(_10d.port?":"+_10d.port:"");
var _10e=_10d.pathname;
var _10f=_10e.lastIndexOf("/");
if(_10f>-1){
_10c[1]=_10e.substr(0,_10f+1);
}
}
return _103(_fa,_fb,_10c);
}
};
...
},set_enableXhtmlFilter:function(_110){
this._enableXhtmlFilter=_110;
},Add:function(_111){
this._filters[this._filters.length]=_111;
},AddAt:function(_112,_113){
this._filters.splice(_113,0,_112);
},RemoveAt:function(_114){
this._filters.splice(_114,1);
},GetFilterAt:function(_115){
return this._filters[_115];
},GetFilterByName:function(name){
for(var i=0;i<this._filters.length;i++){
var _118=this._filters[i];
if(_118&&name==_118.Name){
return _118;
}
}
},GetDesignContent:function(_119){
var _11a=_119;
for(var i=0;i<this._filters.length;i++){
var _11c=this._filters[i];
if((!_11c.IsDom)&&(false!=_11c.Enabled)&&_11c.GetDesignContent){
try{
_11a=_11c.GetDesignContent(_11a);
}
catch(exc){
alert("Error while executing filter "+_11c.Name+" - "+exc.toString());
}
}
}
return _11a;
},GetPreviewContent:function(_11d){
return this.GetDesignContent(_11d);
},GetDesignContentDom:function(_11e){
for(var i=0;i<this._filters.length;i++){
var _120=this._filters[i];
if((_120.IsDom)&&(false!=_120.Enabled)&&_120.GetDesignContent){
try{
_11e=_120.GetDesignContent(_11e);
}
catch(exc){
alert("Error while executing filter "+_120.Name+" - "+exc.toString());
}
}
}
return _11e;
},GetHtmlContent:function(_121){
for(var i=0;i<this._filters.length;i++){
var _123=this._filters[i];
if((_123.IsDom)&&(false!=_123.Enabled)&&_123.GetHtmlContent){
try{
_121=_123.GetHtmlContent(_121);
}
catch(exc){
alert("Error while executing filter "+_123.Name+" - "+exc.toString());
}
}
}
var _124;
...
try{
_124=this._convertToXhtmlFilter.GetHtmlContent(_121);
}
catch(exc){
alert("Error while executing filter XHTML - "+exc.toString());
}
}else{
_124=RadEditorNamespace.Utils.GetOuterHtml(_121);
}
_124=_124.replace(/<body\s*\/>/i,"<body></body>");
for(var i=0;i<this._filters.length;i++){
var _123=this._filters[i];
if((!_123.IsDom)&&(false!=_123.Enabled)&&_123.GetHtmlContent){
try{
_124=_123.GetHtmlContent(_124);
}
catch(exc){
alert("Error while executing filter "+_123.Name+" - "+exc.toString());
}
...
var _3a=[];
function HasAttachedHandler(_3b){
...
var _3d=window.frames;
for(var i=0;i<_3d.length;i++){
if(window["RadEditorPopupInstance"].ContentWindow==_3d[i]){
continue;
}else{
...
try{
_3d[i].window.addEventListener("mousedown",_38,true);
_3a[_3a.length]=_3d[i].window;
}
catch(e){
}
}
...
window.document.addEventListener("mousedown",_38,false);
}
window.addEventListener("load",mouseDownHandler,false);
mouseDownHandler();
}
RadEditorNamespace.Utils.AttachEventEx(window,"unload",function(){
var _3f=window["RadEditorPopupInstance"];
if(_3f&&_3f.Dispose){
_3f.Dispose();
}
});
},0);;RadEditorNamespace.RadCreateRestorePoint=function(_1){
if(!_1||!_1.document){
return null;
}
...
_16.setStartBefore(_19);
_16.setEndBefore(_19);
}
}
catch(exc){
}
