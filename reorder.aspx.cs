...
namespace AspDotNetStorefront
{
	...
	public partial class reorder : SkinBase
	{
		...
		protected override void RenderContents(System.Web.UI.HtmlTextWriter writer)
		{
			...
			{ 
				Response.Write("<p>" + AppLogic.GetString("reorder.aspx.6",SkinID,ThisCustomer.LocaleSetting) + "</p>");
				Response.Write("<p>Error: " + StatusMsg + "</p>");
                Response.Write("<p>" + String.Format(AppLogic.GetString("reorder.aspx.2", SkinID, ThisCustomer.LocaleSetting), "account.aspx", AppLogic.GetString("AppConfig.CartPrompt", SkinID, ThisCustomer.LocaleSetting)) + "</p>");
			}
		}
	}
}
