                                        ...
                                        <table border="0" cellpadding="0" cellspacing="0" width="100%">
                                            ...
                                            <tr>
                                                ...
                                                <td>
                                                    ...
                                                    <asp:RequiredFieldValidator ID="valReqFirstName" ControlToValidate="FirstName" runat="server" Display="None" EnableClientScript="false" ValidationGroup="registration"></asp:RequiredFieldValidator>
                                                </td>
                                            </tr>
                                            <tr>
                                                <td>
                                                ...
                                                <td>
                                                    ...
                                                    <asp:RequiredFieldValidator ID="valReqLastName" ControlToValidate="LastName" runat="server" Display="None" EnableClientScript="false" ValidationGroup="registration"></asp:RequiredFieldValidator>
                                                </td>
                                            </tr>
                                            <tr>
                                                <td>
                                                ...
                                                <td>
                                                    ...
                                                    <asp:CustomValidator ID="valAcctEmail" Display="None" runat="server" EnableClientScript="false" ValidationGroup="registration" OnServerValidate="ValidateAccountEmail"/>
                                                </td>
                                            </tr>
                                            <tr>
                                                <td>
                                                ...
                                                <td>
                                                    ...
                                                    <asp:CustomValidator ID="valPassword" Display="None" EnableClientScript="false" runat="server" ValidationGroup="registration" OnServerValidate="ValidatePassword"></asp:CustomValidator>
                                                </td>
                                            </tr>
                                            <tr>
                                                <td>
                            ...
                            <asp:Table ID="tblSkipRegBox" CellSpacing="0" CellPadding="2" Width="100%" runat="server">
                                <asp:TableRow>
                                    <asp:TableCell HorizontalAlign="left" VerticalAlign="top">
                                        ...
                                        <small><asp:Literal ID="Literal4" runat="server" Text="(!createaccount.aspx.84!)"></asp:Literal></small>
                                        ...
                                        <asp:CustomValidator ID="valReqSkipRegEmail" Display="None" runat="server" EnableClientScript="false" ValidationGroup="skipreg" OnServerValidate="ValidateAccountEmail"/> 
                                        <br />
                    ...
                    <td align="left" valign="top">
                        <asp:Panel ID="pnlBillingInfo" runat="server">
                            <asp:Table ID="tblBillingInfo" CellSpacing="0" CellPadding="0" Width="100%" runat="server">
                                <asp:TableRow>
                                    <asp:TableCell HorizontalAlign="left" VerticalAlign="top">
                                        <asp:Image runat="server" ID="billinginfo_gif" />&#0160;<a href="selectaddress.aspx?add=true&addressType=Billing&Checkout=True&returnURL=checkout1.aspx%3fcheckout%3dTrue"><asp:Literal ID="Literal5" runat="server" Text="(!checkout1.aspx.10!)"></asp:Literal></a><br />
                    ...
                    <td align="left" valign="top">
                        <asp:Panel ID="pnlShippingInfo" runat="server" Visible="false">
                            <asp:Table ID="tblShippingInfo" CellSpacing="0" CellPadding="2" Width="100%" runat="server">
                                <asp:TableRow>
                                    <asp:TableCell HorizontalAlign="left" VerticalAlign="top">
                                        <asp:Image runat="server" ID="shippinginfo_gif" />&#0160;<a href="selectaddress.aspx?add=true&addressType=Shipping&Checkout=True&returnURL=checkout1.aspx%3fcheckout%3dTrue"><asp:Literal ID="Literal3" runat="server" Text="(!checkout1.aspx.11!)"></asp:Literal></a><br />
                                                    ...
                                                    <table border="0" cellpadding="0" cellspacing="0" width="100%">
                                                        ...
                                                        <tr>
                                                            ...
                                                            <td width="65%">
                                                                ...
                                                                <asp:CustomValidator ID="valAddressIsPOBox" ControlToValidate="ShippingAddress1" EnableClientScript="false" runat="server" ValidationGroup="ShippingCheckout1" Display="None" OnServerValidate="ValidateAddress" ></asp:CustomValidator>
                                                            </td>
                                                        </tr>
                                                        <tr>
                                                            <td width="35%">
                                ...
                                <asp:TableCell HorizontalAlign="left" VerticalAlign="top">
                                    ...
                                    <asp:Panel ID="pnlPaymentOptions" runat="server" HorizontalAlign="left" Visible="true">
                                        <table cellpadding="0" cellspacing="0" border="0">
                                            ...
                                            <tr>
                                                <td><asp:RadioButton GroupName="PaymentSelection" ID="pmtCardinalMyECheck" OnCheckedChanged="pmtCardinalMyECheck_CheckedChanged" Text="(!checkoutpayment.aspx.13!)" runat="server" Visible="false" AutoPostBack="true" /></td>
                                                <td></td>
                                            </tr>
                                            <tr>
                                    ...
                                    <asp:Panel ID="paymentPanes" runat="server" HorizontalAlign="left" style="width: 90%; padding-left: 10px; padding-top: 10px; padding-right: 10px; padding-bottom: 20px;">
                                        ...
                                        <asp:Panel ID="pnlCardinalMyECheckPane" runat="server" Visible="false">
                                            <aspdnsf:Topic runat="server" ID="CardinalMyECheckHeader" TopicName="CardinalMyECheckPageHeader" />
                                            <asp:Literal ID="CardinalMyECheckForm" runat="server" Mode="passThrough"></asp:Literal>
                                        </asp:Panel>
