...
<body>
    ...
    <div style="text-align:center;">
        ...
        <form runat="server">
            ...
            <br/><br/>
            <center><asp:Button ID="btnContinueCheckout1" Text="(!checkoutreview.aspx.7!)" CssClass="ReviewPageContinueCheckoutButton" runat="server" OnClick="btnContinueCheckout1_Click" /></center>
            <br /><br />
            ...
            <center><asp:Button ID="btnContinueCheckout2" Text="(!checkoutreview.aspx.7!)" CssClass="ReviewPageContinueCheckoutButton" runat="server" OnClick="btnContinueCheckout2_Click" /></center>
            <br /><br />
