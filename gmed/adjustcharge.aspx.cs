        ...
        protected void Page_Load(object sender, System.EventArgs e)
        {
            ...
            else
            {
                ...
                else
                {
                    ...
                    Response.Write("<p><input type=\"submit\" class=\"normalButtons\" value=\"Submit\" name=\"B1\"><input type=\"button\" class=\"normalButtons\" value=\"Cancel\" name=\"B2\" onClick=\"javascript:self.close()\"></p>");
                    Response.Write("</form>");
                }
            }
