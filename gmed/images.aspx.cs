...
namespace AspDotNetStorefrontAdmin
{
    ...
    public partial class images : AspDotNetStorefront.SkinBase
    {
        ...
        protected override void RenderContents(System.Web.UI.HtmlTextWriter writer)
        {
            ...
            writer.Write("      <td class=\"tablenormal\"><b>File Name</b></td>\n");
            writer.Write("      <td class=\"tablenormal\"><b>Img Tag Src</b></td>\n");
            writer.Write("      <td class=\"tablenormal\"><b>Dimensions</b></td>\n");
            writer.Write("      <td class=\"tablenormal\"><b>Size (KB)</b></td>\n");
            writer.Write("      <td class=\"tablenormal\"><b>Image</b></td>\n");
            writer.Write("      <td class=\"tablenormal\"><b>Delete</b></td>\n");
            writer.Write("    </tr>\n");
            ...
            if (fArray.Count != 0)
            {
                ...
                for (int i = 0; i < fArray.Count; i++)
                {
                    ...
                    writer.Write("    <tr bgcolor=\"" + AppLogic.AppConfig("LightCellColor") + "\">\n");
                    writer.Write("      <td  class=\"" + className + "\">" + fArray[i].ToString() + "</td>\n");
                    writer.Write("      <td class=\"" + className + "\">../images/upload/" + fArray[i].ToString() + "</td>\n");
                    writer.Write("      <td class=\"" + className + "\">" + size.Width.ToString() + "x" + size.Height.ToString() + "</td>\n");
                    writer.Write("      <td class=\"" + className + "\">" + (s / 1000).ToString() + " KB</td>\n");
                    writer.Write("<td class=\"" + className + "\"><a target=\"_blank\" href=\"" + src + "\">\n");
                    ...
                    writer.Write("</a></td>\n");
                    writer.Write("      <td align=\"center\" class=\"" + className + "\"><input type=\"button\" class=\"normalButtons\" value=\"Delete\" name=\"Delete_" + i.ToString() + "\" onClick=\"DeleteImage(" + CommonLogic.SQuote(fArray[i].ToString()) + ")\"></td>\n");
                    writer.Write("    </tr>\n");
                }
            }
            ...
            writer.Write("    </tr>\n");
            writer.Write("  </table>\n");
            writer.Write("<p align=\"left\">Upload A New Image: <input type=\"file\" name=\"Image1\" size=\"50\"><br/><input type=\"submit\" value=\"Submit\" name=\"submit\" class=\"normalButtons\"></p>\n");
            writer.Write("</form>\n");
