                        ...
                        <xsl:when test="boolean($adminsite)">
                            <a>
                                <xsl:attribute name="href">
                                    entityframe.aspx?<xsl:value-of select="$entity"/>id=<xsl:value-of select="EntityID"/>
                                </xsl:attribute>
            ...
            <li>
                <xsl:choose>
                    <xsl:when test="boolean($adminsite)">
                        <a>
                            <xsl:attribute name="href">
                                entityframe.aspx?<xsl:value-of select="$objName"/>id=<xsl:value-of select="ObjectID"/>
                            </xsl:attribute>
                            <xsl:value-of select="$eName"/>
                        </a>
                    </xsl:when>
