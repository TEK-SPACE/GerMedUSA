<%@ Page Language="C#" AutoEventWireup="true" CodeFile="importstringresourcefile1.aspx.cs" Inherits="AspDotNetStorefrontAdmin.importstringresourcefile1" Theme="" %>
                                    ...
                                    <td class="contentTable" valign="top" style="width: 252px">
                                        <div class="wrapper">
                                            ...
                                            *File:
                                            ...
                                            <asp:Button ID="btnSubmit" CssClass="normalButtons" runat="server" Text="Upload" OnClick="btnSubmit_Click" />
                                        </div>
                                    </td>
                                </tr>
                            </table>
                                    ...
                                    <tr>
                                        <td class="contentTable" valign="top" width="100%">
                                            <div class="wrapper">
                                                ...
                                                <asp:Button ID="btnReload" CssClass="normalButtons" runat="server" Text="Reload Preview" OnClick="btnReload_Click"/>
                                            </div>
                                        </td>
                                    </tr>
                                </table>
