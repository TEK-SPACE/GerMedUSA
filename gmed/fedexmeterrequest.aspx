...
<td valign="middle" align="left">Get FedEx Meter</td>
...
<td valign="middle" align="left"><a href="sitemap2.aspx">Site Map</a></td>
			...
			<TABLE BORDER="0" CELLSPACING="1" ID="table1">
				...
				<TR>
					<TD COLSPAN="2">
						<P ALIGN="center">
							<ASP:BUTTON ID="btnSubmitRequest" RUNAT="server" CssClass="normalButtons" TEXT="Submit Request" onclick="btnSubmitRequest_Click"></ASP:BUTTON></P>
					</TD>
				</TR>
			</TABLE>
			<P>
