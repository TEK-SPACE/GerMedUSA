    ...
    public partial class voidorder : System.Web.UI.Page
    {
        protected void Page_Load(object sender, System.EventArgs e)
        {
            ...
            else
            {
                ...
                if (isForceVoid)
                {
                    Response.Write("<b>FORCE VOID ORDER: " + ONX.ToString() + "</b><br/><br/>");
                    if (CommonLogic.FormCanBeDangerousContent("IsSubmit") == "true")
                    {
                        ...
                        Response.Write("Force Voided Status: " + Status);
                    ...
                    {
                        Response.Write("<form method=\"POST\" action=\"voidorder.aspx?ordernumber=" + ONX.ToString() + "&ForceVoid=1" + "&confirm=yes\" id=\"RefundOrderForm\" name=\"RefundOrderForm\">");
                        Response.Write("<input type=\"hidden\" name=\"IsSubmit\" value=\"true\">");
                        Response.Write("<p align=\"center\">Are you sure you want to force void this order?<br/><br/></p>");
                        Response.Write("<p align=\"center\"><input type=\"submit\" class=\"normalButtons\" name=\"submit\" value=\"&nbsp;&nbsp;Yes&nbsp;&nbsp;\">");
                        Response.Write("<img src=\"images/spacer.gif\" width=\"100\" height=\"1\">");
                        Response.Write("<input type=\"button\" class=\"normalButtons\" name=\"cancel\" value=\"&nbsp;&nbsp;No&nbsp;&nbsp;\" onClick=\"javascript:self.close();\">");
                        Response.Write("</p>");
                        Response.Write("</form>");
                    }
                }
