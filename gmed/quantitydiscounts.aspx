<%@ Page Language="C#" AutoEventWireup="true" CodeFile="quantitydiscounts.aspx.cs" Inherits="quantitydiscounts"  %>
                ...
                <td align="left" valign="middle" style="height: 36px">
	                    <table border="0" cellspacing="0" cellpadding="5" class="breadCrumb3">
                            <tr>
                                ...
                                <td align="left" valign="middle">Manage Quantity Discounts</td>
                                        ...
                                        <asp:PlaceHolder ID="phMain" runat="server">
                                            ...
                                            <div style="width: 100%; text-align: left;" runat="server" id="divGrid">
                                                ...
                                                <asp:GridView Width="100%" ID="gMain" runat="server" AutoGenerateColumns="False" CssClass="overallGrid" HorizontalAlign="Left" OnRowCancelingEdit="gMain_RowCancelingEdit" OnRowCommand="gMain_RowCommand" OnRowDataBound="gMain_RowDataBound" OnRowUpdating="gMain_RowUpdating" OnRowEditing="gMain_RowEditing">
                                                    <Columns>
                                                        <asp:CommandField ItemStyle-Width="60" ButtonType="Image" CancelImageUrl="skins/Skin_1/images/cancel.gif" CancelText="Cancel" EditImageUrl="skins/Skin_1/images/edit.gif" EditText="Edit" ShowEditButton="True" UpdateImageUrl="skins/Skin_1/images/update.gif" UpdateText="Update" />
                                                        ...
                                                        <asp:TemplateField ItemStyle-CssClass="selectData" ItemStyle-Width="25">
                                                            <ItemTemplate>
                                                                <asp:ImageButton ID="imgDelete" CommandName="DeleteItem" CommandArgument='<%# Eval("QuantityDiscountTableID") %>' runat="Server" AlternateText="Delete" ImageUrl="skins/Skin_1/images/delete2.gif" />                                                        
                                                            </ItemTemplate>
                                                        </asp:TemplateField>
