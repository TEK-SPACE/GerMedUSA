...
public partial class entityProductVariantsOverview : System.Web.UI.Page
{
    ...
    protected void gMain_RowDataBound(object sender, GridViewRowEventArgs e)
    {
        if (e.Row.RowType == DataControlRowType.DataRow)
        {
            ...
            {
                ltInventory.Text = ("<a href=\"entityEditInventory.aspx?productid=" + myrow["ProductID"].ToString() + "&Variantid=" + myrow["VariantID"].ToString() + "&entityname=" + eName + "&EntityID=" + eID + "\">Inventory</a>\n");
            }
            else
            {
