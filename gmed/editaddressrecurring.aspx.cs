...
namespace AspDotNetStorefrontAdmin
{
    ...
    /// </summary>
    public partial class editaddressrecurring : AspDotNetStorefront.SkinBase
    {
        ...
        private void InitializePageContent()
        {
            ...
            {
                dbconn.Open();
                using (IDataReader dr = DB.GetRS("select * from Country   with (NOLOCK)  where Published = 1 order by DisplayOrder,Name", dbconn))
                {
