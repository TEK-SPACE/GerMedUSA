...
namespace AspDotNetStorefrontAdmin
{
    ...
    public partial class rpt_stats : AspDotNetStorefront.SkinBase
    {
        ...
        protected override void RenderContents(System.Web.UI.HtmlTextWriter writer)
        {
            ...
            writer.Write("    <tr>");
            writer.Write("      <td width=\"50%\" align=\"center\" class=\"tablenormal\"><b>Date Range:</b></td>");
            writer.Write("      <td width=\"50%\" align=\"center\" class=\"tablenormal\"><b>Qualifiers:</b></td>");
            writer.Write("    </tr>");
            writer.Write("    <tr>");
            writer.Write("      <td width=\"50%\" valign=\"top\" align=\"left\" class=\"ordercustomer\">");
            ...
            writer.Write("    </tr>");
            writer.Write("    <tr>");
            writer.Write("      <td style=\"border-top:solid 2px #1B427D; background-color:#ffffff\" width=\"100%\" valign=\"top\" align=\"center\" bgColor=\"#DFECFF\" colspan=\"2\">");
            writer.Write("        <input type=\"submit\" class=\"normalButtons\" value=\"Submit\" name=\"B1\"><input type=\"button\" class=\"normalButtons\" onClick=\"javascript:self.location='rpt_stats.aspx';\" value=\"Reset\" name=\"B2\">");
            writer.Write("      </td>");
            writer.Write("    </tr>");
            writer.Write("  </table>");
            writer.Write("</form>");
            ...
            if (DateWhere.Length != 0)
            {
                ...
                writer.Write("<table width=\"50%\" cellpadding=\"4\" cellspacing=\"0\" border=\"0\" class=\"ordercustomer\">\n");
                writer.Write("<tr class=\"tablenormal\"><td align=\"left\"><b>Statistic</b></td><td align=\"center\"><b>Value</b></td></tr>\n");
                ...
                writer.Write("    <tr>");
                writer.Write("      <td valign=\"top\" align=\"center\" height=\"16px\" bgColor=\"#DFECFF\" colspan=\"2\">");
                writer.Write("    </td>");
                writer.Write("    </tr>");
                writer.Write("</table>\n");
            }
