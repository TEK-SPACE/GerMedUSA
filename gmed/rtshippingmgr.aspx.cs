...
{
    public partial class RTShippingMGR : System.Web.UI.Page
    {
        #region Methods
        ...
        protected void Page_Load(object sender, EventArgs e)
        {
            ...
            litSectionTitle.Text = "<b>Now In : </b> <a href=\"shipping.aspx\">Shipping Method</a> - Manage Real-Time Shipping Providers";
        ...
        protected void grdProviders_RowCommand(object sender, GridViewCommandEventArgs e)
        {
            ...
            {
                case "map":
                    Response.Redirect("rtshippingcountries.aspx?RtShippingProviderID=" + e.CommandArgument);
                    break;
                case "userdata":
                    Response.Redirect("rtshippingproviderspecuserdata.aspx?specfile=" + e.CommandArgument);
                    break;
            }
        }
        #endregion                
