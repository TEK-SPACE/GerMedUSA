...
namespace AspDotNetStorefrontAdmin
{
    ...
    /// </summary>
    public partial class cst_recurring : AspDotNetStorefront.SkinBase
    {
        ...
        protected void Page_Load(object sender, System.EventArgs e)
        {
            ...
            SectionTitle = "<a href=\"Customers.aspx?searchfor=" + TargetCustomer.CustomerID.ToString() + "\">Customers</a> - <a href=\"cst_history.aspx?customerid=" + TargetCustomer.CustomerID.ToString() + "\">Order History</a> - Recurring Shipments For: " + TargetCustomer.FullName() + " (" + TargetCustomer.EMail + ")";
        }
