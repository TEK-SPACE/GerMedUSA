...
namespace AspDotNetStorefrontAdmin
{
    ...
    public partial class exportProductPricing : System.Web.UI.Page
    {
        ...
        protected void LoadData()
        {
            ...
            {
                rblExport.Items.Remove(rblExport.Items[1]);
                lblBreadcumb.Text = AppLogic.GetString("admin.common.ExportProductPricingExpress", 1, Localization.GetWebConfigLocale());
            }
            else
            {
                lblBreadcumb.Text = AppLogic.GetString("admin.common.ExportProductPricing", 1, Customer.Current.LocaleSetting);
            }
            ...
            if (AppLogic.ProductIsMLExpress())
            {
                divDistributor.Style["display"] = "none";
                divGenre.Style["display"] = "none";
                divVector.Style["display"] = "none";
            }
