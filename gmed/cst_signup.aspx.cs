...
namespace AspDotNetStorefrontAdmin
{
    ...
    public partial class cst_signup : AspDotNetStorefront.SkinBase
	{
		...
		protected override void RenderContents(System.Web.UI.HtmlTextWriter writer)
		{
			...
			writer.Write("  }\n");
			writer.Write("  if (theForm.Password.value.length < 5)\n");
			writer.Write("  {\n");
			writer.Write("    alert(\"Please enter at least 5 characters for the password.\");\n");
            ...
            writer.Write("function setFocus() {\n");
            writer.Write("    document.getElementById('FirstName').focus();\n");
            writer.Write("}\n");

            writer.Write("    window.onload = setFocus;\n");
			...
			writer.Write("        <input type=\"text\" id=\"FirstName\" name=\"FirstName\" size=\"20\" maxlength=\"50\" value=\"\">");
            ...
            if (!AppLogic.ProductIsMLExpress())
            {
                ...
                writer.Write("        <td width=\"75%\" align=\"left\" valign=\"middle\">");
                writer.Write("        <input type=\"text\" name=\"SubscriptionExpiresOn\" id=\"SubscriptionExpiresOn\" size=\"12\" value=\"\">&nbsp;<img src=\"" + AppLogic.LocateImageURL("../skins/skin_" + SkinID.ToString() + "/images/calendar.gif") + "\" style=\"cursor:hand;cursor:pointer;\" align=\"absmiddle\" id=\"f_trigger_s\">");
            ...
            writer.Write("            <td width=\"75%\" align=\"left\" valign=\"top\"> <textarea rows=\"5\" style=\"width: 100%;\" name=\"Notes\"></textarea></td>");
            writer.Write("        </tr>");
			...
			writer.Write("<p align=\"center\"><input class=\"normalButtons\" type=\"submit\" value=\"Create Customer Record\" name=\"Continue\"></p>");
			writer.Write("</form>");
