...
<head runat="server">
    <title>AspDotNetStorefront Admin for Store:
        <asp:Literal ID="ltStoreName" runat="server"></asp:Literal></title>
                    ...
                    <tr>
                        <td align="center">
                            <table width="513" cellpadding="0" cellspacing="0" border="0">
                                <tr>
                                    <td valign="bottom" style="background: url(skins/skin_1/images/logoblue.png) no-repeat" height="140px" width="513px">
                                    </td>
                                </tr>
                                <tr>
                                                                ...
                                                                <td align="center">
                                                                    ...
                                                                    <table cellspacing="0" cellpadding="0" width="80%" border="0">
                                                                        <tr valign="top">
                                                                            <td align="left" height="18" valign="middle">
                                                                                <font class="DarkCellText" size="2"><b>&nbsp;<asp:Label ID="Label4" runat="server"
                                                                                    Text="(!signin.aspx.8!)"></asp:Label></b></font>
                                                                            </td>
                                                                        </tr>
                                                                        <tr valign="top">
                                                                            ...
                                                                            <td align="left" width="100%">
                                                                                <table cellspacing="0" cellpadding="5" width="100%" border="0">
                                                                                    <tr valign="baseline">
                                                                                        <td colspan="2">
                                                                                            <b>
                                                                                                <asp:Label ID="Label3" runat="server" Text="(!signin.aspx.11!)" ForeColor="#FFFFFF"></asp:Label>
                                                                                            </b>
                                                                                        </td>
                                                                                    </tr>
                                                                                    <tr>
                                                                                        <td align="right" valign="middle">
                                                                                            <asp:Label ID="Label5" runat="server" Text="(!signin.aspx.10!)" ForeColor="#FFFFFF"></asp:Label>
                                                                                        </td>
                                                                                    ...
                                                                                    <tr valign="baseline">
                                                                                        <td align="right" valign="middle">
                                                                                            <asp:Label ID="Label7" runat="server" Text="(!signin.aspx.12!)" ForeColor="#FFFFFF"></asp:Label>
                                                                                        </td>
                                                                                        <td class="logintext">
                                                                                    ...
                                                                                    <tr valign="baseline" id="RowSecurityCode" runat="server" visible="false">
                                                                                        ...
                                                                                        <td class="securitycodetext">
                                                                                            ...
                                                                                            <asp:RequiredFieldValidator ID="RequiredFieldValidator1" runat="server" ControlToValidate="SecurityCode"
                                                                                                ErrorMessage="(!signin.aspx.20!)" ValidationGroup="Group1" Enabled="False"></asp:RequiredFieldValidator>
                                                                                        </td>
                                                                                    </tr>
                                                                        ...
                                                                        <tr valign="top">
                                                                            <td style="padding-right: 23px">
                                                                                <p align="right">
                                                                                    <asp:ImageButton ImageUrl="skins/skin_1/images/signin.png" ID="btnSubmit" runat="Server"
                                                                    ...
                                                                    <table cellspacing="0" cellpadding="0" width="80%" border="0">
                                                                        <tr>
                                                                                <td>
                                                                                    <p align="left">
                                                                                        <asp:Label ID="Label6" runat="server" Text="(!signin.aspx.15!)" Font-Bold="true" ForeColor="#FFFFFF"></asp:Label>&nbsp;</p>
                                                                                </td>
                                                                            </tr>
                                                                        <tr valign="top">
                                                                            <td align="left" height="18" valign="middle">
                                                                                <font class="DarkCellText" size="2"><b>&nbsp;<asp:Label ID="Label2" runat="server"
                                                                                    Text="(!signin.aspx.17!)"></asp:Label></b></font>
                                                                            </td>
                                                                        </tr>
                                                                        <tr valign="top">
                                                                            <td align="left">
                                                                                <table cellspacing="0" cellpadding="5" width="100%" border="0">
                                                                                    <tr valign="baseline">
                                                                                        <td align="right" valign="middle">
                                                                                            ...
                                                                                            <asp:Label ID="Label1" runat="server" Text="(!signin.aspx.10!)" ForeColor="#FFFFFF"></asp:Label>
                                                                                        </td>
                                                                                        ...
                                                                                        <img id="imgToolTipHelp" src="skins/skin_1/images/help.png" border="0"  href="javascript:void(0);" style="cursor: normal;" />                                                                                            
                                                                                        </td>
                                                                                    </tr>
                                                                                </table>
                                                                            </td>
                                                                        ...
                                                                        <tr valign="top">
                                                                            <td align="left" style="padding-right: 13px;">
                                                                                <p align="right">
                                                                                    <asp:ImageButton ImageUrl="skins/skin_1/images/requestpwd.png" ID="btnRequestNewPassword" 
                                                                    ...
                                                                    <table cellpadding="5" cellspacing="0" width="80%" border="0">
                                                                        ...
                                                                        <tr valign="top">
                                                                            <td align="right" colspan="2" style="padding-right: 30px">
                                                                                <p align="right">
                                                                                    <asp:ImageButton ImageUrl="skins/skin_1/images/changepwd.png" ID="btnChangePwd" runat="Server"
