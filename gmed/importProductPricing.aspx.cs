...
namespace AspDotNetStorefrontAdmin
{
    ...
    public partial class importProductPricing : System.Web.UI.Page
    {
        ...
        protected void Page_Load(object sender, System.EventArgs e)
        {
            ...
            {
                lblbreadcrumb.Text = "Import Product Pricing from Excel";
                ltResult.Text = ("<b>Xml Imports Not Supported<b>");
            }           
        }
        ...
        protected void btnUpload_Click(object sender, EventArgs e)
        {
            ...
            if (fuFile.HasFile)
            {
                ...
                else
                {
                    if ((AppLogic.ProductIsMLExpress() || AppLogic.ProductIsMLX()) && PostedFile.FileName.EndsWith("xml", StringComparison.InvariantCultureIgnoreCase))
                    {
                        ...
                        errors = "<b>Xml Imports Not Supported<b>";
                    }
                    else
                    {
            ...
            {
                errors = ("<b>There is nothing to be imported</b>");
            }
