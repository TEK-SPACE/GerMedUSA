<%@ Page Language="C#" AutoEventWireup="true" CodeFile="orderReports.aspx.cs" Inherits="AspDotNetStorefrontAdmin.orderReports" Theme="" %>
...
<head runat="server">
    ...
    <script type="text/javascript"  src="jscripts/tableExpander.js" type="text/javascript">
    </script>
                ...
                <td align="left" valign="middle" style="height: 36px">
	                    <table border="0" cellspacing="0" cellpadding="5" class="breadCrumb3">
                            <tr>
                                ...
                                <td align="left" valign="middle">Order Reports</td>
...
--%>                                       </table>
                                    ...
                                    <div class="wrapperTop">
                                        <asp:Button runat="server" ID="btnReport" CssClass="normalButtons" Text="GET REPORT" OnClick="btnReport_Click" />                                   
                                    </div>
                                </td>
                                <td style="width: 5px;" />
                                <td style="width: 1px; background-color: #EBEBEB;" />
