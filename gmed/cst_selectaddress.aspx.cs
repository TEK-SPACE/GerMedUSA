...
namespace AspDotNetStorefrontAdmin
{
    ...
    public partial class cst_selectaddress : AspDotNetStorefront.SkinBase
    {
        ...
        protected override void RenderContents(System.Web.UI.HtmlTextWriter writer)
        {
            ...
            String act = String.Format("cst_selectaddress_process.aspx?CustomerID={0}&AddressType={1}&ReturnUrl={2}", TargetCustomer.CustomerID, AddressType, AppLogic.ReturnURLEncode(ReturnUrl));
            ...
            writer.Write("<p align=\"center\"><input type=\"submit\" value=\"Add New Address\" name=\"Continue\" class=\"normalButtons\"></p>");
