    ...
    public partial class entityBulkInventory : System.Web.UI.Page
    {
        ...
        protected void LoadBody()
        {
            ...
            if (NumProducts > 0)
            {
                ...
                tmpS.Append("<tr><td colspan=\"5\" align=\"right\"><input type=\"submit\" value=\"Inventory Update\" class=\"normalButtons\" name=\"Submit\"></td></tr>");
                ...
                for (int i = 0; i < rowcount; i++)
                {
                    ...
                    tmpS.Append("</td>\n");
                    tmpS.Append("<td align=\"left\" valign=\"middle\">");
                    tmpS.Append("<a target=\"entityBody\" href=\"entityeditproductvariant.aspx?iden=" + ThisProductID.ToString() + "&variantid=" + ThisVariantID.ToString() + "&entityname=" + EntityName + "&entityid=" + EntityID.ToString() + "\">");
