    ...
    public partial class galleryimages : System.Web.UI.Page
    {
        ...
        protected void LoadContent()
        {
            ...
            for (int i = 0; i < myDir.Length; i++)
            {
                ...
                if (myDir[i].FullName.EndsWith("jpg", StringComparison.InvariantCultureIgnoreCase) && 
                    myDir[i].FullName.IndexOf("_LG.JPG", StringComparison.InvariantCultureIgnoreCase) == -1)
                {
            ...
            if (fArray.Count != 0)
            {
                ...
                {                    
                    ...
                    if (i != 0)
                    {
                        tmpS.Append("<input type=\"button\" class=\"normalButtons\" value=\"To First\" name=\"MoveFirst_" + i.ToString() + "\" onClick=\"self.location = 'galleryimages.aspx?galleryid=" + GalleryID.ToString() + "&movefirstid=' + " + (i + 1).ToString() + ";\">");
                        tmpS.Append("<input type=\"button\" class=\"normalButtons\" value=\"Up\" name=\"MoveUp_" + i.ToString() + "\" onClick=\"self.location = 'galleryimages.aspx?galleryid=" + GalleryID.ToString() + "&moveupid=' + " + (i + 1).ToString() + ";\">");
                    }
                    if (i != fArray.Count - 1)
                    {
                        tmpS.Append("<input type=\"button\" class=\"normalButtons\" value=\"Down\" name=\"MoveDown_" + i.ToString() + "\" onClick=\"self.location = 'galleryimages.aspx?galleryid=" + GalleryID.ToString() + "&movedownid=' + " + (i + 1).ToString() + ";\">");
                        tmpS.Append("<input type=\"button\" class=\"normalButtons\" value=\"To Last\" name=\"MoveLast_" + i.ToString() + "\" onClick=\"self.location = 'galleryimages.aspx?galleryid=" + GalleryID.ToString() + "&movelastid=' + " + (i + 1).ToString() + ";\">");
                    }
                    tmpS.Append("</td>\n");
                    tmpS.Append("<td align=\"center\">");
                    tmpS.Append("<input type=\"button\" class=\"normalButtons\" value=\"Delete\" name=\"Delete_" + i.ToString() + "\" onClick=\"DeleteImage(" + (i + 1).ToString() + ")\">");
                    tmpS.Append("</td>\n");
                    tmpS.Append("</tr>\n");
                }
            }
