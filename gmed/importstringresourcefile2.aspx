<%@ Page Language="C#" AutoEventWireup="true" CodeFile="importstringresourcefile2.aspx.cs" Inherits="AspDotNetStorefrontAdmin.importstringresourcefile2" Theme="" %>
...
<body>
    <form id="frmImportStringResourceFile2" runat="server">   
                ...
                <td>
                    <div class="wrapper">                       
                        <table border="0" cellpadding="5" cellspacing="0" class="innerTable" width="100%">
                            <tr>
                                <td class="titleTable">
                                    <font class="subTitle"> Verify File:</font>
                                </td>
                            </tr>
                            <tr>
