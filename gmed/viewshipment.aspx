...
<body>
    <form id="WorldShip" runat="server">
        <table style="width: 402px">
            ...
            <tr>
                <td style="width: 100px">
                    <asp:GridView ID="dview" runat="server" AllowPaging="True" AllowSorting="True" HorizontalAlign="Left" Width="50%" PageSize="50" OnPageIndexChanging="dview_PageIndexChanging" OnSorting="dview_Sorting" >
                        <PagerSettings FirstPageText="&amp;lt;&amp;lt;First Page" LastPageText="Last Page&amp;gt;&amp;gt;" NextPageText="Next&amp;gt;" PreviousPageText="&amp;lt;Previous" Mode="Numeric" Position="TopAndBottom" />
