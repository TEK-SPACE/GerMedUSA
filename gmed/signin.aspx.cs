...
public partial class signin : System.Web.UI.Page
{
    ...
    protected void Page_Load(object sender, EventArgs e)
    {
        ...
        tmpSToolTip.AppendFormat("    $window_addLoad(function(){{ new ToolTip('imgToolTipHelp', 'AdminSiteTooltip', '{0}'); }});\n", AppLogic.GetString("signin.aspx.16", 1, Localization.GetWebConfigLocale()).Replace("'","\\'"));
    ...
    protected void btnSubmit_Click(object sender, EventArgs e)
    {
        ...
        if (AppLogic.AppConfigBool("SecurityCodeRequiredOnAdminLogin"))
        {
            if (Session["SecurityCode"] != null)
            {
                ...
                if (!codeMatch)
                {
                    ltError.Text = "<font color=\"#FF0000\"><b>Invalid Security Code|" + sCode + "|" + fCode + "|</font></b>"; // AppLogic.GetString("lat_signin_process.aspx.1", SkinID, ThisCustomer.LocaleSetting);
            ...
            {
                ltError.Text = "<font color=\"#FF0000\"><b>Invalid Security Code|" + "" + "|" + SecurityCode.Text + "|</font></b>"; // AppLogic.GetString("lat_signin_process.aspx.1", SkinID, ThisCustomer.LocaleSetting);
                SecurityCode.Text = String.Empty;
                SecurityImage.ImageUrl = "../Captcha.ashx?id=1";
                return;
            }
        ...
        if (c.IsRegistered && (c.IsAdminUser || c.IsAdminSuperUser))
        {
            ...
            else
            {
                ...
                if ((c.BadLoginCount + 1) >= AppLogic.AppConfigNativeInt("MaxBadLogins"))
                {
                    ...
                    badlogin = -1;
                    ltError.Text = "<font color=\"#FF0000\"><b>" + AppLogic.GetString("lat_signin_process.aspx.3", SkinID, Localization.GetWebConfigLocale()) + "</b></font>";
                }
                c.UpdateCustomer(
