<%@ Page language="c#" Inherits="AspDotNetStorefrontAdmin.importProductsFromExcel" CodeFile="importProductsFromExcel.aspx.cs" %>
...
<body>
                ...
                <td align="left" valign="middle" style="height: 36px">
	                    <table border="0" cellspacing="0" cellpadding="5" class="breadCrumb3">
                            <tr>
                                ...
                                <td align="left" valign="middle">Import Products from Excel</td>
    ...
    <div id="container">
        <p><b><font color="red">BACKUP YOUR DATABASE BEFORE DOING ANY IMPORTS!</font></b><br />
                            ...
                            <tr>
                                <td class="contentTable" valign="top" width="100%">
                                    <div class="wrapper">
                                        ...
                                        <br /><br />
                                        <asp:Button ID="btnAccept" runat="server" Text="CLICK HERE TO ACCEPT IMPORT" CssClass="normalButtons" OnClick="btnAccept_Click" />
                                        &nbsp;
                                        <asp:Button ID="btnUndo" runat="server" Text="CLICK HERE TO UNDO THE IMPORT" CssClass="normalButtons" OnClick="btnUndo_Click" />
                                        <hr noshade="noshade" />
