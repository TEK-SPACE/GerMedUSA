    ...
    public partial class refundorder : System.Web.UI.Page
    {
        protected void Page_Load(object sender, System.EventArgs e)
        {
            ...
            else
            {
                ...
                Response.Write("<b>FULLY REFUND ORDER: " + ONX.ToString() + "</b><br/><br/>");
                ...
                {
                    Response.Write("<form method=\"POST\" action=\"refundorder.aspx?ordernumber=" + ONX.ToString() + "&confirm=yes\" id=\"RefundOrderForm\" name=\"RefundOrderForm\">");
