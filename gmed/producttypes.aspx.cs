...
namespace AspDotNetStorefrontAdmin
{
	...
	public partial class producttypes : System.Web.UI.Page
	{
        ...
        protected void Page_Load(object sender, EventArgs e)
        {
            ...
            {
                this.selectSQL += "where [name] not like '%pack%' and [name] not like '%kit%' and [name] not like '%gift card%'";
            }
        ...
        protected void btnInsert_Click(object sender, EventArgs e)
        {
            ...
            try
            {
                ...
                string queryNewAdded = selectSQL + CommonLogic.IIF(AppLogic.ProductIsMLExpress(), " and ", " where ") + " [Name]=" + DB.SQuote(name) + " ";
