...
namespace AspDotNetStorefrontAdmin
{
    ...
    public partial class saleprices : AspDotNetStorefront.SkinBase
    {
        ...
        protected override void RenderContents(System.Web.UI.HtmlTextWriter writer)
        {
            ...
            {
                sqlProd = "select * from producttype  with (NOLOCK) where [name] not like '%pack%' and [name] not like '%kit%' and [name] not like '%gift card%' order by DisplayOrder,Name";
            }
            else
            {
            ...
            {
                writer.Write("<tr class=\"table-row\">\n");
                writer.Write("<td align=\"left\" valign=\"middle\">" + DB.RowFieldInt(row, "ProductID").ToString() + "</td>\n");
                writer.Write("<td align=\"left\" valign=\"middle\">" + DB.RowFieldInt(row, "VariantID").ToString() + "</td>\n");
                ...
                writer.Write("</a>");
                writer.Write("</td>\n");
                writer.Write("<td align=\"left\" valign=\"middle\">" + DB.RowField(row, "SKU") + DB.RowField(row, "SKUSuffix") + "</td>\n");
                writer.Write("<td align=\"left\" valign=\"middle\">");
