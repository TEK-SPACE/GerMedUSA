    ...
    public partial class cst_account : AspDotNetStorefront.SkinBase
    {
        ...
        protected void Page_Load(object sender, System.EventArgs e)
        {
            ...
            if (CommonLogic.QueryStringCanBeDangerousContent("blockip") == "true")
            {
                ...
                DB.ExecuteSQL("update Customer Set OkToEmail=0 where CustomerID=" + TargetCustomer.CustomerID.ToString());
            }
            ...
            if (CommonLogic.QueryStringCanBeDangerousContent("clearfailed") == "false")
            {
                DB.ExecuteSQL("update FailedTransaction set CustomerId = " + (TargetCustomer.CustomerID * -1).ToString() + " where CustomerID=" + TargetCustomer.CustomerID.ToString());
            }
        ...
        protected override void RenderContents(System.Web.UI.HtmlTextWriter writer)
        {
            ...
            {
                writer.Write("<p align=\"left\"><b><font color=\"#FF0000\">You are not allowed to view this page because of insufficient authority associated with your account.</font></b></p>");
            }
            else
            {
                ...
                if (TargetCustomer.IsAdminSuperUser)
                {
                    writer.Write("&nbsp;&nbsp;<b>(Super Admin User! - Not All Fields Can be Edited For Your Own Protection!)</b>");
                }
                else if (TargetCustomer.IsAdminUser)
                {
                    writer.Write("&nbsp;&nbsp;<b>(Admin User!)</b>");
                }
                writer.Write("        </td>");
                writer.Write("      </tr>");
                ...
                writer.Write("      <tr>");
                writer.Write("        <td width=\"25%\" align=\"right\" valign=\"middle\">Created On:</td>");
                writer.Write("        <td width=\"75%\" align=\"left\" valign=\"middle\">");
                writer.Write(Localization.ToNativeDateTimeString(TargetCustomer.CreatedOn));
                writer.Write("        </td>");
                writer.Write("      </tr>");
                ...
                if (AppLogic.IPIsRestricted(TargetCustomer.LastIPAddress))
                {
                    ...
                    writer.Write("</b></font>");
                    writer.Write("&nbsp;&nbsp;");
                    writer.Write("<input " + CommonLogic.IIF(TargetCustomer.IsAdminSuperUser, " disabled ", "") + " type=\"button\" name=\"BlockIP\" value=\"Allow This IP Address\" onClick=\"self.location='cst_account.aspx?blockip=false&customerid=" + TargetCustomer.CustomerID.ToString() + "'\" class=\"normalButtons\">");
                }
                else
                {
                    writer.Write(TargetCustomer.LastIPAddress);
                    writer.Write("&nbsp;&nbsp;");
                    writer.Write("<input " + CommonLogic.IIF(TargetCustomer.IsAdminSuperUser, " disabled ", "") + " type=\"button\" name=\"BlockIP\" value=\"Block This IP Address\" onClick=\"self.location='cst_account.aspx?blockip=true&customerid=" + TargetCustomer.CustomerID.ToString() + "'\" class=\"normalButtons\">");
                }
                writer.Write("        </td>");
                writer.Write("      </tr>");

                writer.Write("      <tr>");
                writer.Write("        <td width=\"25%\" align=\"right\" valign=\"middle\">Failed Transactions:</td>");
                writer.Write("        <td width=\"75%\" align=\"left\" valign=\"middle\">");
                int NumFailed = DB.GetSqlN("select count(*) as N from FailedTransaction where CustomerID=" + TargetCustomer.CustomerID.ToString());
                writer.Write("<font color=\"" + CommonLogic.IIF(NumFailed > 0, "red", "black") + "\">");
                writer.Write(NumFailed.ToString() + " Failed Transactions");
                writer.Write("</font>");
                if (NumFailed > 0)
                {
                    writer.Write("&nbsp;&nbsp;");
                    writer.Write("<input type=\"button\" name=\"ClearFailed\" value=\"Clear Failed TX Count\" onClick=\"self.location='cst_account.aspx?clearfailed=false&customerid=" + TargetCustomer.CustomerID.ToString() + "'\" class=\"normalButtons\">");
                }
                writer.Write("        </td>");
                writer.Write("      </tr>");
                ...
                {
                    writer.Write("        <td width=\"25%\" align=\"right\" valign=\"middle\">Customer Session: </td>");
                    writer.Write("        <td width=\"75%\" align=\"left\" valign=\"middle\">");
                    writer.Write("        <input type=\"button\" name=\"ClearSession\" value=\"Clear this User's Session\" onClick=\"self.location='cst_account.aspx?clearsession=true&customerid=" + TargetCustomer.CustomerID.ToString() + "'\" class=\"normalButtons\">");
                    writer.Write("        </td>");
                    writer.Write("      </tr>");
                }
                writer.Write("      <tr>");
                ...
                if (AppLogic.ProductIsMLExpress() == false)
                {
                    ...
                    {
                        dbconn.Open();
                        using (IDataReader rs = DB.GetRS("select * from LocaleSetting   with (NOLOCK)  order by displayorder,description", dbconn))
                        {
                            ...
                            while (rs.Read())
                            {
                                tmpS.Append("<option value=\"" + DB.RSField(rs, "Name") + "\" " + CommonLogic.IIF(TargetCustomer.RealLocale == DB.RSField(rs, "Name"), " selected ", "") + ">" + DB.RSField(rs, "Name") + "</option>");
                            }
                ...
                if ((ThisCustomer.IsAdminSuperUser && (TargetCustomer.IsAdminUser || TargetCustomer.IsAdminSuperUser)) || (!TargetCustomer.IsAdminUser) && TargetCustomer.Active)
                {
                    writer.Write("      <tr>");
                    writer.Write("        <td width=\"25%\" align=\"right\" valign=\"middle\">Reset Password:</td>");
                    writer.Write("        <td width=\"75%\" align=\"left\" valign=\"middle\">");
                    writer.Write("             <input type=\"Button\" onClick=\"ResetPasswordConfirm(" + TargetCustomer.CustomerID.ToString() + ")\" Value=\"Reset To Random Password\" class=\"normalButtons\">");
                    ...
                    if (AllowedToForce)
                    {
                        writer.Write("&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;<input type=\"text\" size=\"15\" name=\"ForcePassword\">&nbsp;<input type=\"submit\" value=\"Forcefully Set New Password\" name=\"ForcePasswordButton\" class=\"normalButtons\">");
                    }
                    writer.Write("        </td>");
                    writer.Write("      </tr>");
                }
                ...
                writer.Write("      <tr>");
                writer.Write("        <td width=\"25%\" align=\"right\" valign=\"middle\">Customer Is Registered:</td>");
                writer.Write("        <td width=\"75%\" align=\"left\" valign=\"middle\">");
                writer.Write(CommonLogic.IIF(TargetCustomer.IsRegistered, "Yes", "No"));
                writer.Write("        </td>");
                writer.Write("      </tr>");
                ...
                writer.Write("        <td width=\"75%\" align=\"left\" valign=\"middle\">");
                writer.Write("        <input " + CommonLogic.IIF(TargetCustomer.IsAdminSuperUser, " disabled ", "") + " type=\"checkbox\" name=\"locked\" " + CommonLogic.IIF(TargetCustomer.Active || TargetCustomer.IsAdminSuperUser, "", "checked") + ">");
                writer.Write("        &nbsp;&nbsp;&nbsp;&nbsp;<input type=\"Button\" onClick=\"ForceLogout(" + TargetCustomer.CustomerID.ToString() + ")\" Value=\"Force Logout\" class=\"normalButtons\">");
                writer.Write("        </td>");
                writer.Write("      </tr>");
                ...
                writer.Write("        <td width=\"75%\" align=\"left\" valign=\"middle\">");
                writer.Write("        <input " + CommonLogic.IIF(TargetCustomer.IsAdminSuperUser, " disabled ", "") + " type=\"checkbox\" name=\"Over13\" " + CommonLogic.IIF(TargetCustomer.IsOver13 || TargetCustomer.IsAdminSuperUser, "checked", "") + ">");
                writer.Write("        </td>");
                writer.Write("      </tr>");
                ...
                if (AppLogic.ProductIsMLExpress() == false)
                {
                    ...
                    writer.Write("        <td width=\"75%\" align=\"left\" valign=\"middle\">");
                    writer.Write("        <input " + CommonLogic.IIF(!ThisCustomer.IsAdminSuperUser || (ThisCustomer.IsAdminSuperUser && TargetCustomer.IsAdminSuperUser), " disabled ", "") + " type=\"checkbox\" name=\"canviewcc\" " + CommonLogic.IIF(TargetCustomer.AdminCanViewCC || TargetCustomer.IsAdminSuperUser, "checked", "") + ">");
                    writer.Write("        </td>");
                    writer.Write("      </tr>");
                }
                if (AppLogic.ProductIsMLX() == false && AppLogic.ProductIsMLExpress() == false)
                {
                    writer.Write("      <tr>");
                ...
                writer.Write("        <td width=\"75%\" align=\"left\" valign=\"middle\">");
                writer.Write("        <input type=\"text\" name=\"Phone\" size=\"14\" maxlength=\"25\" value=\"" + Server.HtmlEncode(TargetCustomer.Phone) + "\">");
                writer.Write("        </td>");
                writer.Write("      </tr>");

                if (AppLogic.AppConfigBool("VAT.Enabled") && AppLogic.ProductIsMLExpress() == false)
                {
                    writer.Write("      <tr>");
                ...
                writer.Write("        <td width=\"75%\" align=\"left\" valign=\"middle\">");
                writer.Write("Yes&nbsp;<INPUT " + CommonLogic.IIF(TargetCustomer.IsAdminSuperUser, " disabled ", "") + " TYPE=\"RADIO\" NAME=\"OKToEMail\" value=\"1\" " + CommonLogic.IIF(TargetCustomer.OKToEMail || TargetCustomer.IsAdminSuperUser, " checked ", "") + ">\n");
                writer.Write("No&nbsp;<INPUT " + CommonLogic.IIF(TargetCustomer.IsAdminSuperUser, " disabled ", "") + " TYPE=\"RADIO\" NAME=\"OKToEMail\" value=\"0\" " + CommonLogic.IIF(TargetCustomer.OKToEMail || TargetCustomer.IsAdminSuperUser, "", " checked ") + ">\n");
                ...
                if (AppLogic.ProductIsMLExpress() == false)
                {
                    ...
                    writer.Write("        <td width=\"75%\" align=\"left\" valign=\"middle\">");
                    writer.Write("Yes&nbsp;<INPUT TYPE=\"RADIO\" NAME=\"CODCompanyCheckAllowed\" value=\"1\" " + CommonLogic.IIF(TargetCustomer.CODCompanyCheckAllowed || TargetCustomer.IsAdminSuperUser, " checked ", "") + ">\n");
                    writer.Write("No&nbsp;<INPUT TYPE=\"RADIO\" NAME=\"CODCompanyCheckAllowed\" value=\"0\" " + CommonLogic.IIF(TargetCustomer.CODCompanyCheckAllowed || TargetCustomer.IsAdminSuperUser, "", " checked ") + ">\n");
                    writer.Write("        </td>");
                    writer.Write("      </tr>");
                    ...
                    writer.Write("        <td width=\"75%\" align=\"left\" valign=\"middle\">");
                    writer.Write("Yes&nbsp;<INPUT TYPE=\"RADIO\" NAME=\"CODNet30Allowed\" value=\"1\" " + CommonLogic.IIF(TargetCustomer.CODNet30Allowed || TargetCustomer.IsAdminSuperUser, " checked ", "") + ">\n");
                    writer.Write("No&nbsp;<INPUT TYPE=\"RADIO\" NAME=\"CODNet30Allowed\" value=\"0\" " + CommonLogic.IIF(TargetCustomer.CODNet30Allowed || TargetCustomer.IsAdminSuperUser, "", " checked ") + ">\n");
                    writer.Write("        </td>");
                    writer.Write("      </tr>");
                    ...
                    {
                        dbconn.Open();
                        using (IDataReader rs = DB.GetRS("select COUNT(*) AS N from Affiliate with (NOLOCK) where deleted=0 ; select * from Affiliate with (NOLOCK) where deleted=0 order by Name", dbconn))
                        {
                            if (rs.Read() && DB.RSFieldInt(rs, "N") > 0)
                            {
                                if (rs.NextResult())
                                {
                                    ...
                                    while (rs.Read())
                                    {
                                        String aName = DB.RSField(rs, "Name");
                                        tmpS.Append("<option value=\"" + DB.RSFieldInt(rs, "AffiliateID").ToString() + "\" " + CommonLogic.IIF(TargetCustomer.AffiliateID == DB.RSFieldInt(rs, "AffiliateID"), " selected ", "") + ">" + aName + " (ID=" + DB.RSFieldInt(rs, "AffiliateID").ToString() + ")</option>");
                                    }
                ...
                if (AppLogic.m_ProductIsML())
                {
                    ...
                    {
                        dbconn.Open();
                        using (IDataReader rs = DB.GetRS("select COUNT(*) AS N from CustomerLevel  with (NOLOCK); select * from CustomerLevel  with (NOLOCK) order by DisplayOrder,Name", dbconn))
                        {
                            if (rs.Read() && DB.RSFieldInt(rs, "N") > 0)
                            {
                                if (rs.NextResult())
                                {
                                    ...
                                    while (rs.Read())
                                    {
                                        tmpS.Append("<option value=\"" + DB.RSFieldInt(rs, "CustomerLevelID") + "\" " + CommonLogic.IIF(TargetCustomer.CustomerLevelID == DB.RSFieldInt(rs, "CustomerLevelID"), " selected ", "") + ">" + DB.RSField(rs, "Name") + " (ID=" + DB.RSFieldInt(rs, "CustomerLevelID").ToString() + ")</option>");
                                    }
                ...
                writer.Write("<p align=\"center\"><input type=\"submit\" value=\"Update Account Information\" name=\"Continue\" class=\"normalButtons\"></p>");
                writer.Write("</form>");
