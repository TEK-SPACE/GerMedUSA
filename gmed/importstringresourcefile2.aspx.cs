...
namespace AspDotNetStorefrontAdmin
{
    ...
    public partial class importstringresourcefile2 : System.Web.UI.Page
    {
        ...
        protected void loadData()
        {
            ...
            tmpS.Append("<tr>\n");
            tmpS.Append("<td class=\"tablenormal\">Row</td>\n");
            tmpS.Append("<td class=\"tablenormal\">Status</td>\n");
            tmpS.Append("<td class=\"tablenormal\">Name</td>\n");
            tmpS.Append("<td class=\"tablenormal\">LocaleSetting</td>\n");
            tmpS.Append("<td class=\"tablenormal\">String Value</td>\n");
            tmpS.Append("</tr>\n");
        ...
        private String ProcessLine(String Name, String LocaleSetting, String ConfigValue, bool preview)
        {
            ...
            if (Name.Length != 0)
            {
                try
                {
                    ...
                    {
                        dbconn.Open();
                        using (IDataReader reader = DB.GetRS(string.Format("SELECT Name, Modified, StringResourceGuid FROM StringResource WHERE Name = {0} AND LocaleSetting = {1}", DB.SQuote(Name), DB.SQuote(LocaleSetting)), dbconn))
                        {
