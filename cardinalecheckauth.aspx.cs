    ...
    public partial class cardinalecheckauth : System.Web.UI.Page
    {
        private void Page_Load(object sender, System.EventArgs e)
        {
            ...
            if (ThisCustomer.ThisCustomerSession["Cardinal.ACSURL"].Length == 0)
            {
                Response.Write("<HTML>\n");
                Response.Write("<BODY>\n");
                Response.Write("<center>" + AppLogic.GetString("cardinalecheckauth.aspx.1", 1, Localization.GetWebConfigLocale()) + "</center>\n");
                Response.Write("</BODY>\n");
                Response.Write("</HTML>\n");
            }
            else
            {
                ...
                Response.Write("	<h1>" + AppLogic.GetString("cardinalecheckauth.aspx.2", 1, Localization.GetWebConfigLocale()) + "</h1>\n");
                Response.Write("	<h2>" + AppLogic.GetString("cardinalecheckauth.aspx.3", 1, Localization.GetWebConfigLocale()) + "<br/></h2>\n");
                Response.Write("	<h3>" + AppLogic.GetString("cardinalecheckauth.aspx.4", 1, Localization.GetWebConfigLocale()) + "</h3>\n");
                Response.Write("	</font>\n");
                Response.Write("	<input type=\"submit\" value=\"" + AppLogic.GetString("cardinalecheckauth.aspx.5", 1, Localization.GetWebConfigLocale()) + "\">\n");
                Response.Write("	</center>\n");
                Response.Write("</noscript>\n");
