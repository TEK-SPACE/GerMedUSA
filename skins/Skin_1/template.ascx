...
<a href="/nxfeed.aspx" target="_blank"><img src="images/feeds.png" width="60" height="60" alt="Feeds" title="Follow our Feeds" /></a>-->
  ...
  <a id="logo" href="default.aspx" title="www.GerMedUSA.com"><b>www.GerMedUSA.com</b></a>
    <div class="flinksnew">
<img src="http://germedusa.com/skins/skin_1/images/Followus.png" alt="Follow us" width="129" height="28" border="0" usemap="#Map" title="Follow us on Social Media" />
<map name="Map">
  <area shape="rect" coords="1,-1,29,27" href="http://twitter.com/germedusa" target="_blank" alt="Twitter">
  <area shape="rect" coords="66,-1,95,29" href="http://www.facebook.com/pages/GerMedUSA/101896609891056" target="_blank" alt="FaceBook">
  <area shape="rect" coords="33,0,62,27" href="http://www.youtube.com/germedusa" target="_blank" alt="YouTube">
    ...
    <li><a  href="/t-contact.aspx" title="" class=" ">Contact us</a></li>
        ...
        <div id="horizNav2">
            ...
            <ul class="tameHoriz">
                ...
                <li>1-800-330-1322<span> | </span></li>
                
            </ul>
            
             
             
              <!-- http://www.rbgx.net Chat Button Link Code --><a href="javascript:void(window.open('http://www.germedusa.com/rbgxLiveChat/chat.php','','width=590,height=550,left=0,top=0,resizable=yes,menubar=no,location=no,status=yes,scrollbars=yes'))"><img src="http://www.germedusa.com/rbgxLiveChat/image.php?id=03"width="90" height="30" border="0" alt="GerMedUSA Live Help"></a><noscript><div><a href="http://www.germedusa.com/rbgxLiveChat/chat.php" target="_blank">Start Live Help Chat</a></div></noscript><div style="margin-top:2px;"></div><!-- http://www.rbgx.net Chat Button Link Code -->
        </div>
...
Shows the logo at URL http://germedusa.com/skins/Skin_1/images/tl_white.gif
Logo type is  ("SC4")
Not Floating
//-->
<a href="http://www.instantssl.com" id="comodoTL">SSL</a>
<script type="text/javascript">TrustLogo("https://germedusa.com/skins/Skin_1/images/tl_whiteb.gif", "SC4", "none");</script><br /><br />
                <ul class="tame">
