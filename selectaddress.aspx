                                        ...
                                        <asp:Repeater ID="AddressList" runat="server">
                                            <ItemTemplate>
                                                ...
                                                <%#  AspDotNetStorefrontCore.CommonLogic.IIF(DataBinder.Eval(Container.DataItem, "PrimaryAddress").ToString() == "1", "<b>", "")%>
                                                        ...
                                                        <br />
                                                        <%# AspDotNetStorefrontCore.CommonLogic.IIF(DataBinder.Eval(Container.DataItem, "Company").ToString().Trim() == "", "", DataBinder.Eval(Container.DataItem, "Company") + "<br />")%>
                                                        <%# AspDotNetStorefrontCore.CommonLogic.IIF(DataBinder.Eval(Container.DataItem, "Address1").ToString().Trim() == "", "", DataBinder.Eval(Container.DataItem, "Address1") + "<br />")%>
                                                        <%# AspDotNetStorefrontCore.CommonLogic.IIF(DataBinder.Eval(Container.DataItem, "Address2").ToString().Trim() == "", "", DataBinder.Eval(Container.DataItem, "Address2") + "<br />")%>
                                                        <%# AspDotNetStorefrontCore.CommonLogic.IIF(DataBinder.Eval(Container.DataItem, "Suite").ToString().Trim() == "", "", DataBinder.Eval(Container.DataItem, "Suite") + "<br />")%>
                                                        <%# AspDotNetStorefrontCore.CommonLogic.IIF(DataBinder.Eval(Container.DataItem, "CityStateZip").ToString().Trim() == "", "", DataBinder.Eval(Container.DataItem, "CityStateZip") + "<br />")%>
                                                        <%# AspDotNetStorefrontCore.CommonLogic.IIF(DataBinder.Eval(Container.DataItem, "Country").ToString().Trim() == "", "", DataBinder.Eval(Container.DataItem, "Country") + "<br />")%>
                                                        <%# AspDotNetStorefrontCore.CommonLogic.IIF(DataBinder.Eval(Container.DataItem, "Phone").ToString().Trim() == "", "", DataBinder.Eval(Container.DataItem, "Phone") + "<br />")%>
