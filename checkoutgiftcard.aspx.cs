...
namespace AspDotNetStorefront
{
    public partial class checkoutgiftcard : SkinBase
    {
        ...
        private void InitializePageContent()
        {
            ...
            checkoutheadergraphic.ImageUrl = AppLogic.LocateImageURL("skins/skin_" + SkinID.ToString() + "/images/step_3_2.gif");
            if (ContainsEmailGiftCards)
            {
        ...
        private void CreateGiftCards(ShoppingCart cart)
        {
            for (int i = 0; i < cart.CartItems.Count; i++)
            {
                ...
                string[] FindProductTypeID = {c.m_ProductTypeId.ToString()};
