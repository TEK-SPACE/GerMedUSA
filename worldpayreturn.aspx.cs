        ...
        protected void Page_Load(object sender, System.EventArgs e)
        {
            ...
            if (TransStatus != "Y")
            {
                ...
                if (!AppLogic.AppConfigBool("WorldPay_OnCancelAutoRedirectToCart"))
                {
                    ...
                    Response.Write("<p align=\"left\"><b>" + AppLogic.GetString("worldpayreturn.aspx.1", 1, Localization.GetWebConfigLocale()) + " <a href=\"" + ReturnURL + "\">" + String.Format(AppLogic.GetString("worldpayreturn.aspx.1", 1, Localization.GetWebConfigLocale()), AppLogic.GetString("AppConfig.CartPrompt", 1, Localization.GetWebConfigLocale()).ToLowerInvariant()) + "</a></b></p>");
                }
                if (AppLogic.AppConfigBool("WorldPay_OnCancelAutoRedirectToCart"))
                {
            ...
            else
            {
                ...
                if (CustomerID != 0)
                {
                    ...
                    Response.Write("<p align=\"left\"><b>" + AppLogic.GetString("worldpayreturn.aspx.3", 1, Localization.GetWebConfigLocale()) + " <a href=\"" + ReturnURL + "\">" + AppLogic.GetString("worldpayreturn.aspx.4", 1, Localization.GetWebConfigLocale()) + "</a></b></p>");
                    if (!NoAutoRefresh)
                    {
                        Response.Write("<script type=\"text/javascript\">\n");
                        Response.Write("self.location='" + ReturnURL + "';\n");
                ...
                else
                {
                    ...
                    Response.Write(AppLogic.GetString("worldpayreturn.aspx.5", 1, Localization.GetWebConfigLocale()));
                    Response.Write("</body></html>");
                }
            }
        }
